...
impl Client {
    ...
    pub fn archive_versions_client(&self) -> archive_versions::Client {
        archive_versions::Client(self.clone())
    }
    pub fn archives_client(&self) -> archives::Client {
        archives::Client(self.clone())
    }
    pub fn cache_rules_client(&self) -> cache_rules::Client {
        cache_rules::Client(self.clone())
    }
    pub fn connected_registries_client(&self) -> connected_registries::Client {
        connected_registries::Client(self.clone())
    }
    pub fn credential_sets_client(&self) -> credential_sets::Client {
        credential_sets::Client(self.clone())
    }
...
pub mod archives {
    ...
    impl Client {
        #[doc = "Lists all archives for the specified container registry and package type."]
        #[doc = ""]
        #[doc = "Arguments:"]
        ...
        #[doc = "* `package_type`: The type of the package resource."]
        pub fn list(
            &self,
        ...
        #[doc = "Gets the properties of the archive."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `subscription_id`: The ID of the target subscription. The value must be an UUID."]
        #[doc = "* `resource_group_name`: The name of the resource group. The name is case insensitive."]
        #[doc = "* `registry_name`: The name of the container registry."]
        #[doc = "* `package_type`: The type of the package resource."]
        #[doc = "* `archive_name`: The name of the archive resource."]
        pub fn get(
            &self,
            subscription_id: impl Into<String>,
            resource_group_name: impl Into<String>,
        ...
        #[doc = "Creates a archive for a container registry with the specified parameters."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `subscription_id`: The ID of the target subscription. The value must be an UUID."]
        #[doc = "* `resource_group_name`: The name of the resource group. The name is case insensitive."]
        ...
        #[doc = "* `package_type`: The type of the package resource."]
        #[doc = "* `archive_name`: The name of the archive resource."]
        #[doc = "* `archive_create_parameters`: The parameters for creating a archive."]
        pub fn create(
            &self,
            subscription_id: impl Into<String>,
            resource_group_name: impl Into<String>,
            ...
            package_type: impl Into<String>,
            archive_name: impl Into<String>,
            archive_create_parameters: impl Into<models::Archive>,
            ...
            create::RequestBuilder {
                ...
                package_type: package_type.into(),
                archive_name: archive_name.into(),
                archive_create_parameters: archive_create_parameters.into(),
            }
        }
        #[doc = "Updates a archive for a container registry with the specified parameters."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `subscription_id`: The ID of the target subscription. The value must be an UUID."]
        #[doc = "* `resource_group_name`: The name of the resource group. The name is case insensitive."]
        ...
        #[doc = "* `package_type`: The type of the package resource."]
        #[doc = "* `archive_name`: The name of the archive resource."]
        #[doc = "* `archive_update_parameters`: The parameters for updating a archive."]
        pub fn update(
            &self,
            subscription_id: impl Into<String>,
            resource_group_name: impl Into<String>,
            ...
            package_type: impl Into<String>,
            archive_name: impl Into<String>,
            archive_update_parameters: impl Into<models::ArchiveUpdateParameters>,
            ...
            update::RequestBuilder {
                ...
                package_type: package_type.into(),
                archive_name: archive_name.into(),
                archive_update_parameters: archive_update_parameters.into(),
            }
        }
        #[doc = "Deletes a archive from a container registry."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `subscription_id`: The ID of the target subscription. The value must be an UUID."]
        #[doc = "* `resource_group_name`: The name of the resource group. The name is case insensitive."]
    ...
    pub mod list {
        ...
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::ArchiveListResult> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::ArchiveListResult = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
        ...
        impl RequestBuilder {
            pub fn into_stream(self) -> azure_core::Pageable<models::ArchiveListResult, azure_core::error::Error> {
                let make_request = move |continuation: Option<String>| {
                    let this = self.clone();
                    async move {
                        let mut url = azure_core :: Url :: parse (& format ! ("{}/subscriptions/{}/resourceGroups/{}/providers/Microsoft.ContainerRegistry/registries/{}/packages/{}/archives" , this . client . endpoint () , & this . subscription_id , & this . resource_group_name , & this . registry_name , & this . package_type)) ? ;
    ...
    pub mod get {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::Archive> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::Archive = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        impl RequestBuilder {
            ...
            pub fn send(self) -> futures::future::BoxFuture<'static, azure_core::Result<Response>> {
                Box::pin({
                    let this = self.clone();
                    async move {
                        let url = azure_core :: Url :: parse (& format ! ("{}/subscriptions/{}/resourceGroups/{}/providers/Microsoft.ContainerRegistry/registries/{}/packages/{}/archives/{}" , this . client . endpoint () , & this . subscription_id , & this . resource_group_name , & this . registry_name , & this . package_type , & this . archive_name)) ? ;
                        let mut req = azure_core::Request::new(url, azure_core::Method::Get);
                        let credential = this.client.token_credential();
                        let token_response = credential.get_token(&this.client.scopes().join(" ")).await?;
                        req.insert_header(
        ...
        impl std::future::IntoFuture for RequestBuilder {
            type Output = azure_core::Result<models::Archive>;
            type IntoFuture = futures::future::BoxFuture<'static, azure_core::Result<models::Archive>>;
    ...
    pub mod create {
        ...
        pub struct RequestBuilder {
            ...
            pub(crate) package_type: String,
            pub(crate) archive_name: String,
            pub(crate) archive_create_parameters: models::Archive,
        }
        impl RequestBuilder {
            ...
            pub fn send(self) -> futures::future::BoxFuture<'static, azure_core::Result<Response>> {
                Box::pin({
                    ...
                    async move {
                        ...
                        let req_body = azure_core::to_json(&this.archive_create_parameters)?;
                        req.set_body(req_body);
                        Ok(Response(this.client.send(&mut req).await?))
                    }
                })
    ...
    pub mod update {
        ...
        pub struct RequestBuilder {
            ...
            pub(crate) package_type: String,
            pub(crate) archive_name: String,
            pub(crate) archive_update_parameters: models::ArchiveUpdateParameters,
        }
        impl RequestBuilder {
            #[doc = "Returns a future that sends the request and returns a [`Response`] object that provides low-level access to full response details."]
            #[doc = ""]
                ...
                Box::pin({
                    ...
                    async move {
                        ...
                        req.url_mut()
                            ...
                            .append_pair(azure_core::query_param::API_VERSION, "2023-08-01-preview");
                        req.insert_header("content-type", "application/json");
                        let req_body = azure_core::to_json(&this.archive_update_parameters)?;
                        req.set_body(req_body);
                        Ok(Response(this.client.send(&mut req).await?))
                    }
                })
...
pub mod archive_versions {
    use super::models;
    pub struct Client(pub(crate) super::Client);
    impl Client {
        #[doc = "Lists all archive versions for the specified container registry, repository type and archive name."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `subscription_id`: The ID of the target subscription. The value must be an UUID."]
        #[doc = "* `resource_group_name`: The name of the resource group. The name is case insensitive."]
        ...
        #[doc = "Gets the properties of the archive version."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `subscription_id`: The ID of the target subscription. The value must be an UUID."]
        #[doc = "* `resource_group_name`: The name of the resource group. The name is case insensitive."]
        ...
        #[doc = "* `package_type`: The type of the package resource."]
        #[doc = "* `archive_name`: The name of the archive resource."]
        #[doc = "* `archive_version_name`: The name of the archive version resource."]
        pub fn get(
            &self,
            subscription_id: impl Into<String>,
            resource_group_name: impl Into<String>,
            ...
            package_type: impl Into<String>,
            archive_name: impl Into<String>,
            archive_version_name: impl Into<String>,
        ) -> get::RequestBuilder {
            get::RequestBuilder {
                client: self.0.clone(),
                subscription_id: subscription_id.into(),
                ...
                package_type: package_type.into(),
                archive_name: archive_name.into(),
                archive_version_name: archive_version_name.into(),
            }
        }
        #[doc = "Creates a archive for a container registry with the specified parameters."]
        #[doc = ""]
        ...
        #[doc = "Deletes a archive version from a container registry."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `subscription_id`: The ID of the target subscription. The value must be an UUID."]
        #[doc = "* `resource_group_name`: The name of the resource group. The name is case insensitive."]
    ...
    pub mod list {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::ArchiveVersionListResult> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::ArchiveVersionListResult = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        impl RequestBuilder {
            pub fn into_stream(self) -> azure_core::Pageable<models::ArchiveVersionListResult, azure_core::error::Error> {
                let make_request = move |continuation: Option<String>| {
                    let this = self.clone();
                    async move {
                        let mut url = azure_core :: Url :: parse (& format ! ("{}/subscriptions/{}/resourceGroups/{}/providers/Microsoft.ContainerRegistry/registries/{}/packages/{}/archives/{}/versions" , this . client . endpoint () , & this . subscription_id , & this . resource_group_name , & this . registry_name , & this . package_type , & this . archive_name)) ? ;
                        let rsp = match continuation {
                            Some(value) => {
                                url.set_path("");
                                url = url.join(&value)?;
    ...
    pub mod get {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::ArchiveVersion> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::ArchiveVersion = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        pub struct RequestBuilder {
            ...
            pub(crate) package_type: String,
            pub(crate) archive_name: String,
            pub(crate) archive_version_name: String,
        }
        impl RequestBuilder {
            #[doc = "Returns a future that sends the request and returns a [`Response`] object that provides low-level access to full response details."]
            #[doc = ""]
            ...
            pub fn send(self) -> futures::future::BoxFuture<'static, azure_core::Result<Response>> {
                Box::pin({
                    let this = self.clone();
                    async move {
                        let url = azure_core :: Url :: parse (& format ! ("{}/subscriptions/{}/resourceGroups/{}/providers/Microsoft.ContainerRegistry/registries/{}/packages/{}/archives/{}/versions/{}" , this . client . endpoint () , & this . subscription_id , & this . resource_group_name , & this . registry_name , & this . package_type , & this . archive_name , & this . archive_version_name)) ? ;
                        let mut req = azure_core::Request::new(url, azure_core::Method::Get);
                        let credential = this.client.token_credential();
                        let token_response = credential.get_token(&this.client.scopes().join(" ")).await?;
                        req.insert_header(
        ...
        impl std::future::IntoFuture for RequestBuilder {
            type Output = azure_core::Result<models::ArchiveVersion>;
            type IntoFuture = futures::future::BoxFuture<'static, azure_core::Result<models::ArchiveVersion>>;
            #[doc = "Returns a future that sends the request and returns the parsed response body."]
            #[doc = ""]
            #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
            #[doc = ""]
...
pub mod cache_rules {
    ...
    pub struct Client(pub(crate) super::Client);
    impl Client {
        #[doc = "Lists all cache rule resources for the specified container registry."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `subscription_id`: The ID of the target subscription. The value must be an UUID."]
        #[doc = "* `resource_group_name`: The name of the resource group. The name is case insensitive."]
        ...
        #[doc = "Gets the properties of the specified cache rule resource."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `subscription_id`: The ID of the target subscription. The value must be an UUID."]
        #[doc = "* `resource_group_name`: The name of the resource group. The name is case insensitive."]
        #[doc = "* `registry_name`: The name of the container registry."]
        #[doc = "* `cache_rule_name`: The name of the cache rule."]
        pub fn get(
            &self,
            subscription_id: impl Into<String>,
            resource_group_name: impl Into<String>,
            registry_name: impl Into<String>,
            cache_rule_name: impl Into<String>,
        ) -> get::RequestBuilder {
            get::RequestBuilder {
                client: self.0.clone(),
                subscription_id: subscription_id.into(),
                resource_group_name: resource_group_name.into(),
                registry_name: registry_name.into(),
                cache_rule_name: cache_rule_name.into(),
            }
        }
        #[doc = "Creates a cache rule for a container registry with the specified parameters."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `subscription_id`: The ID of the target subscription. The value must be an UUID."]
        #[doc = "* `resource_group_name`: The name of the resource group. The name is case insensitive."]
        #[doc = "* `registry_name`: The name of the container registry."]
        #[doc = "* `cache_rule_name`: The name of the cache rule."]
        #[doc = "* `cache_rule_create_parameters`: The parameters for creating a cache rule."]
        pub fn create(
            &self,
            subscription_id: impl Into<String>,
            resource_group_name: impl Into<String>,
            registry_name: impl Into<String>,
            cache_rule_name: impl Into<String>,
            cache_rule_create_parameters: impl Into<models::CacheRule>,
        ) -> create::RequestBuilder {
            create::RequestBuilder {
                client: self.0.clone(),
                subscription_id: subscription_id.into(),
                ...
                registry_name: registry_name.into(),
                cache_rule_name: cache_rule_name.into(),
                cache_rule_create_parameters: cache_rule_create_parameters.into(),
            }
        }
        #[doc = "Updates a cache rule for a container registry with the specified parameters."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `subscription_id`: The ID of the target subscription. The value must be an UUID."]
        #[doc = "* `resource_group_name`: The name of the resource group. The name is case insensitive."]
        #[doc = "* `registry_name`: The name of the container registry."]
        #[doc = "* `cache_rule_name`: The name of the cache rule."]
        #[doc = "* `cache_rule_update_parameters`: The parameters for updating a cache rule."]
        pub fn update(
            &self,
            subscription_id: impl Into<String>,
            resource_group_name: impl Into<String>,
            registry_name: impl Into<String>,
            cache_rule_name: impl Into<String>,
            cache_rule_update_parameters: impl Into<models::CacheRuleUpdateParameters>,
        ) -> update::RequestBuilder {
            update::RequestBuilder {
                client: self.0.clone(),
                subscription_id: subscription_id.into(),
                ...
                registry_name: registry_name.into(),
                cache_rule_name: cache_rule_name.into(),
                cache_rule_update_parameters: cache_rule_update_parameters.into(),
            }
        }
        #[doc = "Deletes a cache rule resource from a container registry."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `subscription_id`: The ID of the target subscription. The value must be an UUID."]
        #[doc = "* `resource_group_name`: The name of the resource group. The name is case insensitive."]
    ...
    pub mod list {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::CacheRulesListResult> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::CacheRulesListResult = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        impl RequestBuilder {
            pub fn into_stream(self) -> azure_core::Pageable<models::CacheRulesListResult, azure_core::error::Error> {
                let make_request = move |continuation: Option<String>| {
                    let this = self.clone();
                    async move {
                        let mut url = azure_core::Url::parse(&format!(
                            "{}/subscriptions/{}/resourceGroups/{}/providers/Microsoft.ContainerRegistry/registries/{}/cacheRules",
    ...
    pub mod get {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::CacheRule> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::CacheRule = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        pub struct RequestBuilder {
            ...
            pub(crate) resource_group_name: String,
            pub(crate) registry_name: String,
            pub(crate) cache_rule_name: String,
        }
        impl RequestBuilder {
            #[doc = "Returns a future that sends the request and returns a [`Response`] object that provides low-level access to full response details."]
            #[doc = ""]
        ...
        impl std::future::IntoFuture for RequestBuilder {
            type Output = azure_core::Result<models::CacheRule>;
            type IntoFuture = futures::future::BoxFuture<'static, azure_core::Result<models::CacheRule>>;
            #[doc = "Returns a future that sends the request and returns the parsed response body."]
            #[doc = ""]
            #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
            #[doc = ""]
    ...
    pub mod create {
        ...
        pub struct RequestBuilder {
            ...
            pub(crate) registry_name: String,
            pub(crate) cache_rule_name: String,
            pub(crate) cache_rule_create_parameters: models::CacheRule,
        }
        impl RequestBuilder {
            #[doc = "only the first response will be fetched as long running operations are not supported yet"]
            #[doc = "Returns a future that sends the request and returns a [`Response`] object that provides low-level access to full response details."]
                ...
                Box::pin({
                    ...
                    async move {
                        ...
                        req.url_mut()
                            ...
                            .append_pair(azure_core::query_param::API_VERSION, "2023-08-01-preview");
                        req.insert_header("content-type", "application/json");
                        let req_body = azure_core::to_json(&this.cache_rule_create_parameters)?;
                        req.set_body(req_body);
                        Ok(Response(this.client.send(&mut req).await?))
                    }
                })
    ...
    pub mod update {
        ...
        pub struct RequestBuilder {
            ...
            pub(crate) registry_name: String,
            pub(crate) cache_rule_name: String,
            pub(crate) cache_rule_update_parameters: models::CacheRuleUpdateParameters,
        }
        impl RequestBuilder {
            #[doc = "only the first response will be fetched as long running operations are not supported yet"]
            #[doc = "Returns a future that sends the request and returns a [`Response`] object that provides low-level access to full response details."]
                ...
                Box::pin({
                    ...
                    async move {
                        ...
                        req.url_mut()
                            ...
                            .append_pair(azure_core::query_param::API_VERSION, "2023-08-01-preview");
                        req.insert_header("content-type", "application/json");
                        let req_body = azure_core::to_json(&this.cache_rule_update_parameters)?;
                        req.set_body(req_body);
                        Ok(Response(this.client.send(&mut req).await?))
                    }
                })
...
pub mod credential_sets {
    ...
    pub struct Client(pub(crate) super::Client);
    impl Client {
        #[doc = "Lists all credential set resources for the specified container registry."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `subscription_id`: The ID of the target subscription. The value must be an UUID."]
        #[doc = "* `resource_group_name`: The name of the resource group. The name is case insensitive."]
        ...
        #[doc = "Gets the properties of the specified credential set resource."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `subscription_id`: The ID of the target subscription. The value must be an UUID."]
        #[doc = "* `resource_group_name`: The name of the resource group. The name is case insensitive."]
        #[doc = "* `registry_name`: The name of the container registry."]
        #[doc = "* `credential_set_name`: The name of the credential set."]
        pub fn get(
            &self,
            subscription_id: impl Into<String>,
            resource_group_name: impl Into<String>,
            registry_name: impl Into<String>,
            credential_set_name: impl Into<String>,
        ) -> get::RequestBuilder {
            get::RequestBuilder {
                client: self.0.clone(),
                subscription_id: subscription_id.into(),
                resource_group_name: resource_group_name.into(),
                registry_name: registry_name.into(),
                credential_set_name: credential_set_name.into(),
            }
        }
        #[doc = "Creates a credential set for a container registry with the specified parameters."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `subscription_id`: The ID of the target subscription. The value must be an UUID."]
        #[doc = "* `resource_group_name`: The name of the resource group. The name is case insensitive."]
        #[doc = "* `registry_name`: The name of the container registry."]
        #[doc = "* `credential_set_name`: The name of the credential set."]
        #[doc = "* `credential_set_create_parameters`: The parameters for creating a credential set."]
        pub fn create(
            &self,
            subscription_id: impl Into<String>,
            resource_group_name: impl Into<String>,
            registry_name: impl Into<String>,
            credential_set_name: impl Into<String>,
            credential_set_create_parameters: impl Into<models::CredentialSet>,
        ) -> create::RequestBuilder {
            create::RequestBuilder {
                client: self.0.clone(),
                subscription_id: subscription_id.into(),
                ...
                registry_name: registry_name.into(),
                credential_set_name: credential_set_name.into(),
                credential_set_create_parameters: credential_set_create_parameters.into(),
            }
        }
        #[doc = "Updates a credential set for a container registry with the specified parameters."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `subscription_id`: The ID of the target subscription. The value must be an UUID."]
        #[doc = "* `resource_group_name`: The name of the resource group. The name is case insensitive."]
        #[doc = "* `registry_name`: The name of the container registry."]
        #[doc = "* `credential_set_name`: The name of the credential set."]
        #[doc = "* `credential_set_update_parameters`: The parameters for updating a credential set."]
        pub fn update(
            &self,
            subscription_id: impl Into<String>,
            resource_group_name: impl Into<String>,
            registry_name: impl Into<String>,
            credential_set_name: impl Into<String>,
            credential_set_update_parameters: impl Into<models::CredentialSetUpdateParameters>,
        ) -> update::RequestBuilder {
            update::RequestBuilder {
                client: self.0.clone(),
                subscription_id: subscription_id.into(),
                ...
                registry_name: registry_name.into(),
                credential_set_name: credential_set_name.into(),
                credential_set_update_parameters: credential_set_update_parameters.into(),
            }
        }
        #[doc = "Deletes a credential set from a container registry."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `subscription_id`: The ID of the target subscription. The value must be an UUID."]
        #[doc = "* `resource_group_name`: The name of the resource group. The name is case insensitive."]
    ...
    pub mod list {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::CredentialSetListResult> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::CredentialSetListResult = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        impl RequestBuilder {
            pub fn into_stream(self) -> azure_core::Pageable<models::CredentialSetListResult, azure_core::error::Error> {
                let make_request = move |continuation: Option<String>| {
                    let this = self.clone();
                    async move {
                        let mut url = azure_core::Url::parse(&format!(
                            "{}/subscriptions/{}/resourceGroups/{}/providers/Microsoft.ContainerRegistry/registries/{}/credentialSets",
                            this.client.endpoint(),
                            &this.subscription_id,
                            &this.resource_group_name,
                            &this.registry_name
    ...
    pub mod get {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::CredentialSet> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::CredentialSet = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        pub struct RequestBuilder {
            ...
            pub(crate) resource_group_name: String,
            pub(crate) registry_name: String,
            pub(crate) credential_set_name: String,
        }
        impl RequestBuilder {
            #[doc = "Returns a future that sends the request and returns a [`Response`] object that provides low-level access to full response details."]
            #[doc = ""]
        ...
        impl std::future::IntoFuture for RequestBuilder {
            type Output = azure_core::Result<models::CredentialSet>;
            type IntoFuture = futures::future::BoxFuture<'static, azure_core::Result<models::CredentialSet>>;
            #[doc = "Returns a future that sends the request and returns the parsed response body."]
            #[doc = ""]
            #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
            #[doc = ""]
    ...
    pub mod create {
        ...
        pub struct RequestBuilder {
            ...
            pub(crate) registry_name: String,
            pub(crate) credential_set_name: String,
            pub(crate) credential_set_create_parameters: models::CredentialSet,
        }
        impl RequestBuilder {
            #[doc = "only the first response will be fetched as long running operations are not supported yet"]
            #[doc = "Returns a future that sends the request and returns a [`Response`] object that provides low-level access to full response details."]
                ...
                Box::pin({
                    ...
                    async move {
                        ...
                        req.url_mut()
                            ...
                            .append_pair(azure_core::query_param::API_VERSION, "2023-08-01-preview");
                        req.insert_header("content-type", "application/json");
                        let req_body = azure_core::to_json(&this.credential_set_create_parameters)?;
                        req.set_body(req_body);
                        Ok(Response(this.client.send(&mut req).await?))
                    }
                })
    ...
    pub mod update {
        ...
        pub struct RequestBuilder {
            ...
            pub(crate) registry_name: String,
            pub(crate) credential_set_name: String,
            pub(crate) credential_set_update_parameters: models::CredentialSetUpdateParameters,
        }
        impl RequestBuilder {
            #[doc = "only the first response will be fetched as long running operations are not supported yet"]
            #[doc = "Returns a future that sends the request and returns a [`Response`] object that provides low-level access to full response details."]
                ...
                Box::pin({
                    ...
                    async move {
                        ...
                        req.url_mut()
                            ...
                            .append_pair(azure_core::query_param::API_VERSION, "2023-08-01-preview");
                        req.insert_header("content-type", "application/json");
                        let req_body = azure_core::to_json(&this.credential_set_update_parameters)?;
                        req.set_body(req_body);
                        Ok(Response(this.client.send(&mut req).await?))
                    }
                })
