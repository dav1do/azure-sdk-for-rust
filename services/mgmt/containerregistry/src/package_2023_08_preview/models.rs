...
#[doc = "An object that represents a archive for a container registry."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct Archive {
    #[serde(flatten)]
    pub proxy_resource: ProxyResource,
    #[doc = "The properties of a archive."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
...
#[doc = "The result of a request to list archives for a container registry."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct ArchiveListResult {
    #[doc = "The list of archives. Since this list may be incomplete, the nextLink field should be used to request the next list of distributions."]
    #[serde(
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
        skip_serializing_if = "Vec::is_empty"
    )]
    pub value: Vec<Archive>,
    #[doc = "The URI that can be used to request the next list of archives."]
    #[serde(rename = "nextLink", default, skip_serializing_if = "Option::is_none")]
    pub next_link: Option<String>,
}
impl azure_core::Continuable for ArchiveListResult {
    type Continuation = String;
    fn continuation(&self) -> Option<Self::Continuation> {
        self.next_link.clone()
    }
...
#[doc = "The properties of the archive package source."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct ArchivePackageSourceProperties {
    #[doc = "The type of package source for a archive."]
    #[serde(rename = "type", default, skip_serializing_if = "Option::is_none")]
    pub type_: Option<archive_package_source_properties::Type>,
    #[doc = "The external repository url."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub url: Option<String>,
}
impl ArchivePackageSourceProperties {
    pub fn new() -> Self {
        Self::default()
    }
}
pub mod archive_package_source_properties {
    use super::*;
    #[doc = "The type of package source for a archive."]
    #[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
    #[serde(remote = "Type")]
    ...
    impl Serialize for Type {
        ...
        {
            match self {
                Self::Remote => serializer.serialize_unit_variant("Type", 0u32, "remote"),
                Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
            }
        }
    }
...
pub struct ArchiveProperties {
    #[doc = "The properties of the archive package source."]
    #[serde(rename = "packageSource", default, skip_serializing_if = "Option::is_none")]
    pub package_source: Option<ArchivePackageSourceProperties>,
    #[doc = "The published version of the archive."]
    #[serde(rename = "publishedVersion", default, skip_serializing_if = "Option::is_none")]
    pub published_version: Option<String>,
    #[serde(rename = "repositoryEndpointPrefix", default, skip_serializing_if = "Option::is_none")]
    pub repository_endpoint_prefix: Option<String>,
    #[serde(rename = "repositoryEndpoint", default, skip_serializing_if = "Option::is_none")]
    pub repository_endpoint: Option<String>,
    #[doc = "The provisioning state of the archive at the time the operation was called."]
    #[serde(rename = "provisioningState", default, skip_serializing_if = "Option::is_none")]
    pub provisioning_state: Option<archive_properties::ProvisioningState>,
}
...
#[doc = "The parameters for updating a archive."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct ArchiveUpdateParameters {
    #[doc = "The properties of a archive."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub properties: Option<ArchiveUpdateProperties>,
}
impl ArchiveUpdateParameters {
    pub fn new() -> Self {
        Self::default()
    }
}
#[doc = "The properties of a archive."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct ArchiveUpdateProperties {
    #[doc = "The published version of the archive."]
    #[serde(rename = "publishedVersion", default, skip_serializing_if = "Option::is_none")]
    pub published_version: Option<String>,
}
impl ArchiveUpdateProperties {
    pub fn new() -> Self {
        Self::default()
    }
}
...
pub struct ArchiveVersion {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub properties: Option<ArchiveVersionProperties>,
}
impl ArchiveVersion {
    pub fn new() -> Self {
        Self::default()
...
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct ArchiveVersionListResult {
    ...
    pub value: Vec<ArchiveVersion>,
    #[doc = "The URI that can be used to request the next list of pipeline runs."]
    #[serde(rename = "nextLink", default, skip_serializing_if = "Option::is_none")]
    pub next_link: Option<String>,
}
impl azure_core::Continuable for ArchiveVersionListResult {
    type Continuation = String;
    fn continuation(&self) -> Option<Self::Continuation> {
        self.next_link.clone()
    }
}
impl ArchiveVersionListResult {
    pub fn new() -> Self {
        Self::default()
    }
}
#[doc = "The properties of an export pipeline."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct ArchiveVersionProperties {
    #[doc = "The provisioning state of the archive at the time the operation was called."]
    #[serde(rename = "provisioningState", default, skip_serializing_if = "Option::is_none")]
    pub provisioning_state: Option<archive_version_properties::ProvisioningState>,
    #[doc = "The detailed error message for the archive version in the case of failure."]
    #[serde(rename = "archiveVersionErrorMessage", default, skip_serializing_if = "Option::is_none")]
    pub archive_version_error_message: Option<String>,
}
impl ArchiveVersionProperties {
    pub fn new() -> Self {
        Self::default()
    }
}
pub mod archive_version_properties {
    use super::*;
    #[doc = "The provisioning state of the archive at the time the operation was called."]
    #[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
    #[serde(remote = "ProvisioningState")]
...
#[doc = "Authentication credential stored for an upstream."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct AuthCredential {
    #[doc = "The name of the credential."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub name: Option<auth_credential::Name>,
    #[doc = "KeyVault Secret URI for accessing the username."]
    #[serde(rename = "usernameSecretIdentifier", default, skip_serializing_if = "Option::is_none")]
    pub username_secret_identifier: Option<String>,
    #[doc = "KeyVault Secret URI for accessing the password."]
    #[serde(rename = "passwordSecretIdentifier", default, skip_serializing_if = "Option::is_none")]
    pub password_secret_identifier: Option<String>,
    #[doc = "The health of the auth credential."]
    #[serde(rename = "credentialHealth", default, skip_serializing_if = "Option::is_none")]
    pub credential_health: Option<CredentialHealth>,
}
impl AuthCredential {
    pub fn new() -> Self {
        Self::default()
...
pub mod auth_credential {
    ...
    impl Serialize for Name {
        ...
        {
            match self {
                Self::Credential1 => serializer.serialize_unit_variant("Name", 0u32, "Credential1"),
                Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
            }
        }
    }
...
#[doc = "The policy for using ARM audience token for a container registry."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct AzureAdAuthenticationAsArmPolicy {
    #[doc = "The value that indicates whether the policy is enabled or not."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub status: Option<azure_ad_authentication_as_arm_policy::Status>,
}
impl AzureAdAuthenticationAsArmPolicy {
    pub fn new() -> Self {
        Self::default()
    }
}
pub mod azure_ad_authentication_as_arm_policy {
    use super::*;
    #[doc = "The value that indicates whether the policy is enabled or not."]
    #[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
    #[serde(remote = "Status")]
...
#[doc = "An object that represents a cache rule for a container registry."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct CacheRule {
    #[serde(flatten)]
    pub proxy_resource: ProxyResource,
    #[doc = "The properties of a cache rule."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub properties: Option<CacheRuleProperties>,
}
impl CacheRule {
    pub fn new() -> Self {
        Self::default()
...
pub struct CacheRuleProperties {
    #[doc = "The ARM resource ID of the credential store which is associated with the cache rule."]
    #[serde(rename = "credentialSetResourceId", default, skip_serializing_if = "Option::is_none")]
    pub credential_set_resource_id: Option<String>,
    #[doc = "Source repository pulled from upstream."]
    #[serde(rename = "sourceRepository", default, skip_serializing_if = "Option::is_none")]
    pub source_repository: Option<String>,
    #[doc = "Target repository specified in docker pull command.\r\nEg: docker pull myregistry.azurecr.io/{targetRepository}:{tag}"]
    #[serde(rename = "targetRepository", default, skip_serializing_if = "Option::is_none")]
...
impl CacheRuleProperties {
    pub fn new() -> Self {
        Self::default()
    }
}
pub mod cache_rule_properties {
    use super::*;
    #[doc = "Provisioning state of the resource."]
    #[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
    #[serde(remote = "ProvisioningState")]
...
#[doc = "The parameters for updating a cache rule."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct CacheRuleUpdateParameters {
    #[doc = "The parameters for updating cache rule properties."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub properties: Option<CacheRuleUpdateProperties>,
}
impl CacheRuleUpdateParameters {
    pub fn new() -> Self {
        Self::default()
    }
}
...
impl CacheRuleUpdateProperties {
    pub fn new() -> Self {
        Self::default()
    }
}
#[doc = "The result of a request to list cache rules for a container registry."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct CacheRulesListResult {
    #[doc = "The list of cache rules."]
    #[serde(
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
        skip_serializing_if = "Vec::is_empty"
    )]
    pub value: Vec<CacheRule>,
    #[doc = "If provided, client must use NextLink URI to request next list of cache rules."]
    #[serde(rename = "nextLink", default, skip_serializing_if = "Option::is_none")]
    pub next_link: Option<String>,
}
impl azure_core::Continuable for CacheRulesListResult {
    type Continuation = String;
    fn continuation(&self) -> Option<Self::Continuation> {
        self.next_link.clone()
    }
}
impl CacheRulesListResult {
    pub fn new() -> Self {
        Self::default()
    }
}
    ...
    impl Serialize for Mode {
            ...
            S: Serializer,
        {
            match self {
                ...
                Self::Registry => serializer.serialize_unit_variant("Mode", 2u32, "Registry"),
                Self::Mirror => serializer.serialize_unit_variant("Mode", 3u32, "Mirror"),
                Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
            }
        }
    }
...
pub struct CredentialHealth {
    #[doc = "The health status of credential."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub status: Option<credential_health::Status>,
    #[doc = "Error code representing the health check error."]
    #[serde(rename = "errorCode", default, skip_serializing_if = "Option::is_none")]
    pub error_code: Option<String>,
    #[doc = "Descriptive message representing the health check error."]
...
pub mod credential_health {
    ...
    impl Serialize for Status {
        ...
        {
            match self {
                Self::Healthy => serializer.serialize_unit_variant("Status", 0u32, "Healthy"),
                Self::Unhealthy => serializer.serialize_unit_variant("Status", 1u32, "Unhealthy"),
                Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
            }
        }
    }
}
#[doc = "An object that represents a credential set resource for a container registry."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct CredentialSet {
    ...
    #[doc = "The properties of a credential set resource."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub properties: Option<CredentialSetProperties>,
}
impl CredentialSet {
    pub fn new() -> Self {
        Self::default()
...
#[doc = "The result of a request to list credential sets for a container registry."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct CredentialSetListResult {
    #[doc = "The list of credential sets. Since this list may be incomplete, the nextLink field should be used to request the next list of credential sets."]
    #[serde(
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
        skip_serializing_if = "Vec::is_empty"
    )]
    pub value: Vec<CredentialSet>,
    #[doc = "The URI that can be used to request the next list of credential sets."]
    #[serde(rename = "nextLink", default, skip_serializing_if = "Option::is_none")]
    pub next_link: Option<String>,
}
impl azure_core::Continuable for CredentialSetListResult {
    type Continuation = String;
    fn continuation(&self) -> Option<Self::Continuation> {
        self.next_link.clone()
    }
}
impl CredentialSetListResult {
    pub fn new() -> Self {
        Self::default()
    }
}
...
pub struct CredentialSetProperties {
    #[doc = "The credentials are stored for this upstream or login server."]
    #[serde(rename = "loginServer", default, skip_serializing_if = "Option::is_none")]
    pub login_server: Option<String>,
    #[doc = "List of authentication credentials stored for an upstream.\r\nUsually consists of a primary and an optional secondary credential."]
    #[serde(
...
impl CredentialSetProperties {
    pub fn new() -> Self {
        Self::default()
    }
}
pub mod credential_set_properties {
    use super::*;
    #[doc = "Provisioning state of the resource."]
    #[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
    #[serde(remote = "ProvisioningState")]
...
#[doc = "The parameters for updating a credential set"]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct CredentialSetUpdateParameters {
    #[doc = "The parameters for updating credential set properties."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub properties: Option<CredentialSetUpdateProperties>,
    #[doc = "Managed identity for the resource."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub identity: Option<IdentityProperties>,
}
impl CredentialSetUpdateParameters {
    pub fn new() -> Self {
        Self::default()
    }
}
...
impl CredentialSetUpdateProperties {
    pub fn new() -> Self {
        Self::default()
    }
}
...
#[doc = "The properties of the archive package source."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct DebianArchivePackageSourceProperties {
    #[serde(flatten)]
    pub archive_package_source_properties: ArchivePackageSourceProperties,
    #[doc = "Upstream Debian distribution Name."]
    #[serde(rename = "distributionName", default, skip_serializing_if = "Option::is_none")]
    pub distribution_name: Option<String>,
}
impl DebianArchivePackageSourceProperties {
    pub fn new() -> Self {
        Self::default()
    }
}
#[doc = "The properties of the Debian package Archive."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct DebianArchiveProperties {
    #[serde(flatten)]
    pub archive_properties: ArchiveProperties,
    #[doc = "Debian distribution Name."]
    #[serde(rename = "distributionName", default, skip_serializing_if = "Option::is_none")]
    pub distribution_name: Option<String>,
}
impl DebianArchiveProperties {
    pub fn new() -> Self {
        Self::default()
    }
}
...
#[doc = "The properties of a package type."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct PackageType {
    #[doc = "The name of the package type."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub name: Option<String>,
    #[doc = "The endpoint of the package type."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
...
pub struct Policies {
    ...
    #[doc = "The policy for using ARM audience token for a container registry."]
    #[serde(rename = "azureADAuthenticationAsArmPolicy", default, skip_serializing_if = "Option::is_none")]
    pub azure_ad_authentication_as_arm_policy: Option<AzureAdAuthenticationAsArmPolicy>,
    #[doc = "The soft delete policy for a container registry"]
...
pub struct SoftDeletePolicy {
    #[doc = "The number of days after which a soft-deleted item is permanently deleted."]
    ...
    #[doc = "The value that indicates whether the policy is enabled or not."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub status: Option<soft_delete_policy::Status>,
}
