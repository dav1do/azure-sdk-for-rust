...
pub struct AzureBackupJob {
    ...
    pub rehydration_priority: Option<String>,
...
pub struct AzureBackupRestoreRequest {
    ...
    #[serde(rename = "identityDetails", default, skip_serializing_if = "Option::is_none")]
    pub identity_details: Option<IdentityDetails>,
}
...
pub struct BackupVault {
    ...
    #[serde(rename = "secureScore", default, skip_serializing_if = "Option::is_none")]
    pub secure_score: Option<backup_vault::SecureScore>,
}
impl BackupVault {
...
pub mod backup_vault {
    ...
    #[doc = "Secure Score of Backup Vault"]
    #[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
    #[serde(remote = "SecureScore")]
    pub enum SecureScore {
        None,
        Minimum,
        Adequate,
        Maximum,
    ...
    impl FromStr for SecureScore {
        type Err = value::Error;
        fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
            Self::deserialize(s.into_deserializer())
        }
    }
    impl<'de> Deserialize<'de> for SecureScore {
        fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
        where
            D: Deserializer<'de>,
        {
    ...
    impl Serialize for SecureScore {
        fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
        where
            S: Serializer,
        {
            match self {
                Self::None => serializer.serialize_unit_variant("SecureScore", 0u32, "None"),
                Self::Minimum => serializer.serialize_unit_variant("SecureScore", 1u32, "Minimum"),
                Self::Adequate => serializer.serialize_unit_variant("SecureScore", 2u32, "Adequate"),
                Self::Maximum => serializer.serialize_unit_variant("SecureScore", 3u32, "Maximum"),
                Self::NotSupported => serializer.serialize_unit_variant("SecureScore", 4u32, "NotSupported"),
                Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
            }
        }
    }
...
pub struct CrossRegionRestoreSettings {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub state: Option<cross_region_restore_settings::State>,
}
impl CrossRegionRestoreSettings {
    pub fn new() -> Self {
        Self::default()
    }
}
pub mod cross_region_restore_settings {
    use super::*;
    #[doc = "CrossRegionRestore state"]
    #[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
    #[serde(remote = "State")]
...
pub struct FeatureSettings {
    ...
    #[serde(rename = "crossRegionRestoreSettings", default, skip_serializing_if = "Option::is_none")]
    pub cross_region_restore_settings: Option<CrossRegionRestoreSettings>,
}
...
pub struct IdentityDetails {
    ...
    #[serde(rename = "userAssignedIdentityArmUrl", default, skip_serializing_if = "Option::is_none")]
    pub user_assigned_identity_arm_url: Option<String>,
}
...
pub struct KubernetesClusterBackupDatasourceParameters {
    ...
    #[serde(
        rename = "backupHookReferences",
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
        skip_serializing_if = "Vec::is_empty"
    )]
    pub backup_hook_references: Vec<NamespacedNameResource>,
}
impl KubernetesClusterBackupDatasourceParameters {
    pub fn new(
        ...
        Self {
            ...
            backup_hook_references: Vec::new(),
        }
    }
}
...
pub struct KubernetesClusterRestoreCriteria {
    ...
    #[serde(
        rename = "restoreHookReferences",
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
        skip_serializing_if = "Vec::is_empty"
    )]
    pub restore_hook_references: Vec<NamespacedNameResource>,
}
impl KubernetesClusterRestoreCriteria {
    pub fn new(item_level_restore_criteria: ItemLevelRestoreCriteria, include_cluster_scope_resources: bool) -> Self {
        Self {
            ...
            restore_hook_references: Vec::new(),
        }
    }
}
...
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct NamespacedNameResource {
