...
pub struct DelegatedControllerProperties {
    ...
    #[doc = "The purpose of the dnc controller resource."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub purpose: Option<delegated_controller_properties::Purpose>,
}
...
pub mod delegated_controller_properties {
    ...
    impl Serialize for Purpose {
        ...
        {
            match self {
                Self::Test => serializer.serialize_unit_variant("Purpose", 0u32, "test"),
                Self::Prod => serializer.serialize_unit_variant("Purpose", 1u32, "prod"),
                Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
            }
        }
    }
...
pub struct DelegatedSubnetProperties {
    ...
    #[doc = "Defines prefix size of CIDR blocks allocated to nodes in VnetBlock Mode.\r\nDelegated subnet's prefix size should be smaller than this by a minimum of 3."]
    #[serde(rename = "allocationBlockPrefixSize", default, skip_serializing_if = "Option::is_none")]
    pub allocation_block_prefix_size: Option<i32>,
}
