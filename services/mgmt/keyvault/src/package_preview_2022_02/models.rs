...
#[doc = "The parameters used to check the availability of the managed hsm name."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct CheckMhsmNameAvailabilityParameters {
    #[doc = "The managed hsm name."]
    pub name: String,
}
impl CheckMhsmNameAvailabilityParameters {
    pub fn new(name: String) -> Self {
        Self { name }
    }
}
#[doc = "The CheckMhsmNameAvailability operation response."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct CheckMhsmNameAvailabilityResult {
    ...
    #[doc = "The reason that a managed hsm name could not be used. The reason element is only returned if NameAvailable is false."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub reason: Option<check_mhsm_name_availability_result::Reason>,
    #[doc = "An error message explaining the Reason value in more detail."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub message: Option<String>,
}
impl CheckMhsmNameAvailabilityResult {
    pub fn new() -> Self {
        Self::default()
    }
}
pub mod check_mhsm_name_availability_result {
    use super::*;
    #[doc = "The reason that a managed hsm name could not be used. The reason element is only returned if NameAvailable is false."]
    #[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
    #[serde(remote = "Reason")]
    ...
    impl Serialize for Reason {
        ...
        {
            match self {
                Self::AccountNameInvalid => serializer.serialize_unit_variant("Reason", 0u32, "AccountNameInvalid"),
...
#[doc = "The security domain properties of the managed hsm."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct ManagedHsmSecurityDomainProperties {
    ...
    pub activation_status: Option<managed_hsm_security_domain_properties::ActivationStatus>,
    #[doc = "Activation Status Message."]
    #[serde(rename = "activationStatusMessage", default, skip_serializing_if = "Option::is_none")]
    pub activation_status_message: Option<String>,
}
impl ManagedHsmSecurityDomainProperties {
    pub fn new() -> Self {
        Self::default()
    }
}
pub mod managed_hsm_security_domain_properties {
    use super::*;
    #[doc = "Activation Status"]
    #[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
    #[serde(remote = "ActivationStatus")]
    ...
    impl Serialize for ActivationStatus {
        ...
        {
            match self {
                Self::Active => serializer.serialize_unit_variant("ActivationStatus", 0u32, "Active"),
                Self::NotActivated => serializer.serialize_unit_variant("ActivationStatus", 1u32, "NotActivated"),
                Self::Unknown => serializer.serialize_unit_variant("ActivationStatus", 2u32, "Unknown"),
                Self::Failed => serializer.serialize_unit_variant("ActivationStatus", 3u32, "Failed"),
                Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
            }
        }
    }
...
pub struct ManagedHsmProperties {
    ...
    pub scheduled_purge_date: Option<time::OffsetDateTime>,
    #[doc = "The security domain properties of the managed hsm."]
    #[serde(rename = "securityDomainProperties", default, skip_serializing_if = "Option::is_none")]
