...
impl Client {
    ...
    pub fn backups_under_account_client(&self) -> backups_under_account::Client {
        backups_under_account::Client(self.clone())
    }
    pub fn backups_under_backup_vault_client(&self) -> backups_under_backup_vault::Client {
        backups_under_backup_vault::Client(self.clone())
    }
    pub fn backups_under_volume_client(&self) -> backups_under_volume::Client {
        backups_under_volume::Client(self.clone())
    }
...
pub mod backups {
    ...
    pub struct Client(pub(crate) super::Client);
    impl Client {
        #[doc = "Get the latest backup status of a volume"]
        #[doc = "Get the latest status of the backup for a volume"]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `subscription_id`: The ID of the target subscription."]
        #[doc = "* `resource_group_name`: The name of the resource group. The name is case insensitive."]
        ...
        pub fn get_latest_status(
            ...
            pool_name: impl Into<String>,
            volume_name: impl Into<String>,
        ) -> get_latest_status::RequestBuilder {
            get_latest_status::RequestBuilder {
                client: self.0.clone(),
                subscription_id: subscription_id.into(),
                resource_group_name: resource_group_name.into(),
        ...
        #[doc = "List Backups"]
        #[doc = "List all backups Under a Backup Vault"]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `subscription_id`: The ID of the target subscription."]
        #[doc = "* `resource_group_name`: The name of the resource group. The name is case insensitive."]
        #[doc = "* `account_name`: The name of the NetApp account"]
        #[doc = "* `backup_vault_name`: The name of the Backup Vault"]
        pub fn list_by_vault(
            ...
            list_by_vault::RequestBuilder {
                ...
                resource_group_name: resource_group_name.into(),
                account_name: account_name.into(),
                backup_vault_name: backup_vault_name.into(),
                filter: None,
            }
        }
        #[doc = "Describe the Backup under Backup Vault"]
        #[doc = "Get the specified Backup under Backup Vault."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `subscription_id`: The ID of the target subscription."]
        #[doc = "* `resource_group_name`: The name of the resource group. The name is case insensitive."]
        ...
        #[doc = "Create a backup"]
        #[doc = "Create a backup under the Backup Vault"]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `subscription_id`: The ID of the target subscription."]
        #[doc = "* `resource_group_name`: The name of the resource group. The name is case insensitive."]
        ...
        #[doc = "Patch a backup"]
        #[doc = "Patch a Backup under the Backup Vault"]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `subscription_id`: The ID of the target subscription."]
        #[doc = "* `resource_group_name`: The name of the resource group. The name is case insensitive."]
        ...
        #[doc = "Delete backup"]
        #[doc = "Delete a Backup under the Backup Vault"]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `subscription_id`: The ID of the target subscription."]
        #[doc = "* `resource_group_name`: The name of the resource group. The name is case insensitive."]
        ...
        impl RequestBuilder {
            ...
            pub fn send(self) -> futures::future::BoxFuture<'static, azure_core::Result<Response>> {
                Box::pin({
                    let this = self.clone();
                    async move {
                        let url = azure_core :: Url :: parse (& format ! ("{}/subscriptions/{}/resourceGroups/{}/providers/Microsoft.NetApp/netAppAccounts/{}/capacityPools/{}/volumes/{}/latestBackupStatus/current" , this . client . endpoint () , & this . subscription_id , & this . resource_group_name , & this . account_name , & this . pool_name , & this . volume_name)) ? ;
                        let mut req = azure_core::Request::new(url, azure_core::Method::Get);
                        let credential = this.client.token_credential();
                        let token_response = credential.get_token(&this.client.scopes().join(" ")).await?;
                        req.insert_header(
    ...
    pub mod list_by_vault {
        ...
        pub struct RequestBuilder {
            ...
            pub(crate) resource_group_name: String,
            pub(crate) account_name: String,
            pub(crate) backup_vault_name: String,
            pub(crate) filter: Option<String>,
        }
        impl RequestBuilder {
            #[doc = "An option to specify the VolumeResourceId. If present, then only returns the backups under the specified volume"]
            pub fn filter(mut self, filter: impl Into<String>) -> Self {
                self.filter = Some(filter.into());
                self
            }
            pub fn into_stream(self) -> azure_core::Pageable<models::BackupsList, azure_core::error::Error> {
                let make_request = move |continuation: Option<String>| {
                    let this = self.clone();
                    async move {
                        let mut url = azure_core::Url::parse(&format!(
                            "{}/subscriptions/{}/resourceGroups/{}/providers/Microsoft.NetApp/netAppAccounts/{}/backupVaults/{}/backups",
                            this.client.endpoint(),
                            &this.subscription_id,
                            &this.resource_group_name,
                            &this.account_name,
                            &this.backup_vault_name
                        ))?;
                        let rsp = match continuation {
                            Some(value) => {
                                url.set_path("");
...
pub mod account_backups {
    ...
    impl Client {
        ...
        pub fn list_by_net_app_account(
            ...
            list_by_net_app_account::RequestBuilder {
                ...
                resource_group_name: resource_group_name.into(),
                account_name: account_name.into(),
                include_only_backups_from_deleted_volumes: None,
            }
        }
    ...
    pub mod list_by_net_app_account {
        ...
        pub struct RequestBuilder {
            ...
            pub(crate) resource_group_name: String,
            pub(crate) account_name: String,
            pub(crate) include_only_backups_from_deleted_volumes: Option<String>,
        }
        impl RequestBuilder {
            #[doc = "An option to specify whether to return backups only from deleted volumes"]
            pub fn include_only_backups_from_deleted_volumes(
                mut self,
                include_only_backups_from_deleted_volumes: impl Into<String>,
            ) -> Self {
                self.include_only_backups_from_deleted_volumes = Some(include_only_backups_from_deleted_volumes.into());
                self
            }
            #[doc = "only the first response will be fetched as the continuation token is not part of the response schema"]
            #[doc = "Returns a future that sends the request and returns a [`Response`] object that provides low-level access to full response details."]
                ...
                Box::pin({
                    ...
                    async move {
                        ...
                        req.url_mut()
                            .query_pairs_mut()
                            .append_pair(azure_core::query_param::API_VERSION, "2022-11-01-preview");
                        if let Some(include_only_backups_from_deleted_volumes) = &this.include_only_backups_from_deleted_volumes {
                            req.url_mut()
                                .query_pairs_mut()
                                .append_pair("includeOnlyBackupsFromDeletedVolumes", include_only_backups_from_deleted_volumes);
                        }
                        let req_body = azure_core::EMPTY_BODY;
                        req.set_body(req_body);
                        Ok(Response(this.client.send(&mut req).await?))
...
pub mod backup_vaults {
    ...
    pub struct Client(pub(crate) super::Client);
    impl Client {
        #[doc = "Describe all Backup Vaults"]
        #[doc = "List and describe all Backup Vaults in the NetApp account."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `subscription_id`: The ID of the target subscription."]
        #[doc = "* `resource_group_name`: The name of the resource group. The name is case insensitive."]
        ...
        #[doc = "Describe the Backup Vault"]
        #[doc = "Get the Backup Vault"]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `subscription_id`: The ID of the target subscription."]
        #[doc = "* `resource_group_name`: The name of the resource group. The name is case insensitive."]
        ...
        #[doc = "Create or Update a Backup Vault"]
        #[doc = "Create or update the specified Backup Vault in the NetApp account"]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `subscription_id`: The ID of the target subscription."]
        #[doc = "* `resource_group_name`: The name of the resource group. The name is case insensitive."]
        #[doc = "* `account_name`: The name of the NetApp account"]
        #[doc = "* `backup_vault_name`: The name of the Backup Vault"]
        #[doc = "* `body`: BackupVault object supplied in the body of the operation."]
        pub fn create_or_update(
            &self,
            subscription_id: impl Into<String>,
            resource_group_name: impl Into<String>,
            account_name: impl Into<String>,
            backup_vault_name: impl Into<String>,
            body: impl Into<models::BackupVault>,
        ) -> create_or_update::RequestBuilder {
            create_or_update::RequestBuilder {
                client: self.0.clone(),
                subscription_id: subscription_id.into(),
        ...
        #[doc = "Update NetApp Backup Vault"]
        #[doc = "Patch the specified NetApp Backup Vault"]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `subscription_id`: The ID of the target subscription."]
        #[doc = "* `resource_group_name`: The name of the resource group. The name is case insensitive."]
        #[doc = "* `account_name`: The name of the NetApp account"]
        #[doc = "* `backup_vault_name`: The name of the Backup Vault"]
        #[doc = "* `body`: Backup Vault object supplied in the body of the operation."]
        pub fn update(
            &self,
            subscription_id: impl Into<String>,
            resource_group_name: impl Into<String>,
            account_name: impl Into<String>,
            backup_vault_name: impl Into<String>,
            body: impl Into<models::BackupVaultPatch>,
        ) -> update::RequestBuilder {
            update::RequestBuilder {
                client: self.0.clone(),
                subscription_id: subscription_id.into(),
        ...
        #[doc = "Delete NetApp Backup Vault"]
        #[doc = "Delete the specified Backup Vault"]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `subscription_id`: The ID of the target subscription."]
        #[doc = "* `resource_group_name`: The name of the resource group. The name is case insensitive."]
    ...
    pub mod list_by_net_app_account {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::BackupVaultsList> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::BackupVaultsList = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        impl RequestBuilder {
            pub fn into_stream(self) -> azure_core::Pageable<models::BackupVaultsList, azure_core::error::Error> {
                let make_request = move |continuation: Option<String>| {
                    let this = self.clone();
                    async move {
                        let mut url = azure_core::Url::parse(&format!(
                            "{}/subscriptions/{}/resourceGroups/{}/providers/Microsoft.NetApp/netAppAccounts/{}/backupVaults",
                            this.client.endpoint(),
                            &this.subscription_id,
                            &this.resource_group_name,
                            &this.account_name
    ...
    pub mod get {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::BackupVault> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::BackupVault = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        impl std::future::IntoFuture for RequestBuilder {
            type Output = azure_core::Result<models::BackupVault>;
            type IntoFuture = futures::future::BoxFuture<'static, azure_core::Result<models::BackupVault>>;
            #[doc = "Returns a future that sends the request and returns the parsed response body."]
            #[doc = ""]
            #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
            #[doc = ""]
    ...
    pub mod create_or_update {
        ...
        pub struct RequestBuilder {
            ...
            pub(crate) account_name: String,
            pub(crate) backup_vault_name: String,
            pub(crate) body: models::BackupVault,
        }
        impl RequestBuilder {
            #[doc = "only the first response will be fetched as long running operations are not supported yet"]
            #[doc = "Returns a future that sends the request and returns a [`Response`] object that provides low-level access to full response details."]
    ...
    pub mod update {
        ...
        pub struct RequestBuilder {
            ...
            pub(crate) account_name: String,
            pub(crate) backup_vault_name: String,
            pub(crate) body: models::BackupVaultPatch,
        }
        impl RequestBuilder {
            #[doc = "only the first response will be fetched as long running operations are not supported yet"]
            #[doc = "Returns a future that sends the request and returns a [`Response`] object that provides low-level access to full response details."]
...
pub mod backups_under_backup_vault {
    use super::models;
    pub struct Client(pub(crate) super::Client);
    impl Client {
        ...
        impl RequestBuilder {
            ...
            pub fn send(self) -> futures::future::BoxFuture<'static, azure_core::Result<Response>> {
                Box::pin({
                    let this = self.clone();
                    async move {
                        let url = azure_core :: Url :: parse (& format ! ("{}/subscriptions/{}/resourceGroups/{}/providers/Microsoft.NetApp/netAppAccounts/{}/backupVaults/{}/backups/{}/restoreFiles" , this . client . endpoint () , & this . subscription_id , & this . resource_group_name , & this . account_name , & this . backup_vault_name , & this . backup_name)) ? ;
                        let mut req = azure_core::Request::new(url, azure_core::Method::Post);
                        let credential = this.client.token_credential();
                        let token_response = credential.get_token(&this.client.scopes().join(" ")).await?;
                        req.insert_header(
...
pub mod backups_under_volume {
    use super::models;
    pub struct Client(pub(crate) super::Client);
    impl Client {
        #[doc = "Create a new migrate request for backups under volume"]
        #[doc = "Migrate the backups under volume to backup vault"]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `body`: Migrate backups under volume payload supplied in the body of the operation."]
        #[doc = "* `subscription_id`: The ID of the target subscription."]
        #[doc = "* `resource_group_name`: The name of the resource group. The name is case insensitive."]
        #[doc = "* `account_name`: The name of the NetApp account"]
        #[doc = "* `pool_name`: The name of the capacity pool"]
        #[doc = "* `volume_name`: The name of the volume"]
        pub fn migrate_backups(
            &self,
            body: impl Into<models::BackupsMigrationRequest>,
            subscription_id: impl Into<String>,
            resource_group_name: impl Into<String>,
            account_name: impl Into<String>,
            pool_name: impl Into<String>,
            volume_name: impl Into<String>,
        ) -> migrate_backups::RequestBuilder {
            migrate_backups::RequestBuilder {
                client: self.0.clone(),
                body: body.into(),
                subscription_id: subscription_id.into(),
    ...
    pub mod migrate_backups {
        ...
        pub struct RequestBuilder {
            pub(crate) client: super::super::Client,
            pub(crate) body: models::BackupsMigrationRequest,
            pub(crate) subscription_id: String,
            pub(crate) resource_group_name: String,
            pub(crate) account_name: String,
            pub(crate) pool_name: String,
        ...
        impl RequestBuilder {
            ...
            pub fn send(self) -> futures::future::BoxFuture<'static, azure_core::Result<Response>> {
                Box::pin({
                    let this = self.clone();
                    async move {
                        let url = azure_core :: Url :: parse (& format ! ("{}/subscriptions/{}/resourceGroups/{}/providers/Microsoft.NetApp/netAppAccounts/{}/capacityPools/{}/volumes/{}/migrateBackups" , this . client . endpoint () , & this . subscription_id , & this . resource_group_name , & this . account_name , & this . pool_name , & this . volume_name)) ? ;
                        let mut req = azure_core::Request::new(url, azure_core::Method::Post);
                        let credential = this.client.token_credential();
                        let token_response = credential.get_token(&this.client.scopes().join(" ")).await?;
                        req.insert_header(
...
pub mod backups_under_account {
    use super::models;
    pub struct Client(pub(crate) super::Client);
    impl Client {
        #[doc = "Create a new migrate request for backups under account"]
        #[doc = "Migrate the backups under a NetApp account to backup vault"]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `body`: Migrate backups under an account payload supplied in the body of the operation."]
        #[doc = "* `subscription_id`: The ID of the target subscription."]
        #[doc = "* `resource_group_name`: The name of the resource group. The name is case insensitive."]
        #[doc = "* `account_name`: The name of the NetApp account"]
        pub fn migrate_backups(
        ...
        impl RequestBuilder {
            ...
            pub fn send(self) -> futures::future::BoxFuture<'static, azure_core::Result<Response>> {
                Box::pin({
                    ...
                    async move {
                        let url = azure_core::Url::parse(&format!(
                            "{}/subscriptions/{}/resourceGroups/{}/providers/Microsoft.NetApp/netAppAccounts/{}/migrateBackups",
                            this.client.endpoint(),
                            &this.subscription_id,
                            &this.resource_group_name,
                            &this.account_name
