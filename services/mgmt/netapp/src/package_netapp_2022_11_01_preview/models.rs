...
pub struct BackupPatch {
    #[doc = "Backup patch properties"]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub properties: Option<BackupPatchProperties>,
}
impl BackupPatch {
    pub fn new() -> Self {
        Self::default()
...
#[doc = "Backup patch properties"]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct BackupPatchProperties {
    #[doc = "Label for backup"]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub label: Option<String>,
}
impl BackupPatchProperties {
    pub fn new() -> Self {
        Self::default()
    }
}
...
pub struct BackupProperties {
    ...
    #[doc = "ResourceId used to identify the Volume"]
    #[serde(rename = "volumeResourceId")]
...
impl BackupProperties {
    pub fn new(volume_resource_id: String) -> Self {
        Self {
            backup_id: None,
            creation_date: None,
...
#[doc = "Restore payload for single file backup restore"]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct BackupRestoreFiles {
    #[doc = "List of files to be restored"]
    #[serde(rename = "fileList")]
    pub file_list: Vec<String>,
    #[doc = "Destination folder where the files will be restored. The path name should start with a forward slash. If it is omitted from request then restore is done at the root folder of the destination volume by default"]
    #[serde(rename = "restoreFilePath", default, skip_serializing_if = "Option::is_none")]
    pub restore_file_path: Option<String>,
    #[doc = "Resource Id of the destination volume on which the files need to be restored"]
    #[serde(rename = "destinationVolumeId")]
    pub destination_volume_id: String,
}
impl BackupRestoreFiles {
    pub fn new(file_list: Vec<String>, destination_volume_id: String) -> Self {
        Self {
            file_list,
...
pub struct BackupStatus {
    ...
    #[doc = "Displays the total number of bytes transferred for the ongoing operation"]
    #[serde(rename = "transferProgressBytes", default, skip_serializing_if = "Option::is_none")]
    pub transfer_progress_bytes: Option<i64>,
}
impl BackupStatus {
    pub fn new() -> Self {
        Self::default()
...
#[doc = "Backup Vault information"]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct BackupVault {
    #[serde(flatten)]
    pub tracked_resource: TrackedResource,
    #[doc = "Backup Vault properties"]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub properties: Option<BackupVaultProperties>,
}
impl BackupVault {
...
#[doc = "Backup Vault information"]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct BackupVaultPatch {
    #[doc = "Tags are a list of key-value pairs that describe the resource"]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub tags: Option<ResourceTags>,
}
impl BackupVaultPatch {
    pub fn new() -> Self {
        Self::default()
    }
}
...
impl BackupVaultProperties {
    pub fn new() -> Self {
        Self::default()
    }
}
#[doc = "List of Backup Vaults"]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct BackupVaultsList {
    #[doc = "A list of Backup Vaults"]
    #[serde(
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
        skip_serializing_if = "Vec::is_empty"
    )]
    pub value: Vec<BackupVault>,
    #[doc = "URL to get the next set of results."]
    #[serde(rename = "nextLink", default, skip_serializing_if = "Option::is_none")]
    pub next_link: Option<String>,
}
impl azure_core::Continuable for BackupVaultsList {
    type Continuation = String;
    fn continuation(&self) -> Option<Self::Continuation> {
        self.next_link.clone()
    }
}
impl BackupVaultsList {
    pub fn new() -> Self {
        Self::default()
    }
}
...
#[doc = "Migrate Backups Request"]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct BackupsMigrationRequest {
    #[doc = "The ResourceId of the Backup Vault"]
    #[serde(rename = "backupVaultId")]
    pub backup_vault_id: String,
}
impl BackupsMigrationRequest {
    pub fn new(backup_vault_id: String) -> Self {
        Self { backup_vault_id }
    }
}
...
pub struct VolumeBackupProperties {
    ...
    #[serde(rename = "backupVaultId", default, skip_serializing_if = "Option::is_none")]
...
pub struct VolumePatchProperties {
    ...
    pub smb_access_based_enumeration: Option<volume_patch_properties::SmbAccessBasedEnumeration>,
    ...
    pub smb_non_browsable: Option<volume_patch_properties::SmbNonBrowsable>,
