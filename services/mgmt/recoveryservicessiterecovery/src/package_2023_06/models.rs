...
#[doc = "ExtendedLocation details data."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct A2aExtendedLocationDetails {
    #[doc = "Extended location of the resource."]
...
impl A2aExtendedLocationDetails {
    pub fn new() -> Self {
        Self::default()
    }
}
...
pub struct A2aFabricSpecificLocationDetails {
    ...
    #[doc = "Initial primary fabric location info."]
    ...
    #[doc = "The initial recovery fabric location info."]
...
pub struct A2aProtectedDiskDetails {
    ...
    #[serde(
        rename = "allowedDiskLevelOperation",
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
        skip_serializing_if = "Vec::is_empty"
    )]
...
pub struct A2aReplicationDetails {
    ...
    #[serde(rename = "recoveryCapacityReservationGroupId", default, skip_serializing_if = "Option::is_none")]
    pub recovery_capacity_reservation_group_id: Option<String>,
    #[doc = "A value indicating the churn option selected by user."]
    #[serde(rename = "churnOptionSelected", default, skip_serializing_if = "Option::is_none")]
...
pub mod a2a_replication_details {
    ...
    #[doc = "A value indicating the churn option selected by user."]
    #[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
    #[serde(remote = "ChurnOptionSelected")]
    pub enum ChurnOptionSelected {
        Normal,
        High,
        #[serde(skip_deserializing)]
        UnknownValue(String),
    }
    impl FromStr for ChurnOptionSelected {
        type Err = value::Error;
        fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
            Self::deserialize(s.into_deserializer())
        }
    }
    impl<'de> Deserialize<'de> for ChurnOptionSelected {
        fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
        where
            D: Deserializer<'de>,
        {
    ...
    impl Serialize for ChurnOptionSelected {
        fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
        where
            S: Serializer,
        {
            match self {
                Self::Normal => serializer.serialize_unit_variant("ChurnOptionSelected", 0u32, "Normal"),
                Self::High => serializer.serialize_unit_variant("ChurnOptionSelected", 1u32, "High"),
                Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
            }
        }
    }
...
pub struct A2aUpdateReplicationProtectedItemInput {
    ...
    #[serde(
        rename = "managedDiskUpdateDetails",
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
        skip_serializing_if = "Vec::is_empty"
    )]
...
#[doc = "Appliance details of the migration item."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct ApplianceMonitoringDetails {
    #[doc = "Details of the appliance resource."]
    #[serde(rename = "cpuDetails", default, skip_serializing_if = "Option::is_none")]
    pub cpu_details: Option<ApplianceResourceDetails>,
    #[doc = "Details of the appliance resource."]
    #[serde(rename = "ramDetails", default, skip_serializing_if = "Option::is_none")]
    pub ram_details: Option<ApplianceResourceDetails>,
    #[doc = "The appliance datastore snapshot details."]
    #[serde(
        rename = "datastoreSnapshot",
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
        skip_serializing_if = "Vec::is_empty"
    )]
    pub datastore_snapshot: Vec<DataStoreUtilizationDetails>,
    #[doc = "Details of the appliance resource."]
    #[serde(rename = "disksReplicationDetails", default, skip_serializing_if = "Option::is_none")]
    pub disks_replication_details: Option<ApplianceResourceDetails>,
    #[doc = "Details of the appliance resource."]
    #[serde(rename = "esxiNfcBuffer", default, skip_serializing_if = "Option::is_none")]
    pub esxi_nfc_buffer: Option<ApplianceResourceDetails>,
    #[doc = "Details of the appliance resource."]
    #[serde(rename = "networkBandwidth", default, skip_serializing_if = "Option::is_none")]
    pub network_bandwidth: Option<ApplianceResourceDetails>,
}
impl ApplianceMonitoringDetails {
    pub fn new() -> Self {
        Self::default()
    }
}
...
#[doc = "Details of the appliance resource."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct ApplianceResourceDetails {
    #[doc = "A value indicating the total capacity of appliance resource."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub capacity: Option<i64>,
    #[doc = "A value indicating the utilization percentage by gateway agent on appliance."]
    #[serde(rename = "processUtilization", default, skip_serializing_if = "Option::is_none")]
    pub process_utilization: Option<f64>,
    #[doc = "A value indicating the total utilization percentage for all processes on the appliance."]
    #[serde(rename = "totalUtilization", default, skip_serializing_if = "Option::is_none")]
    pub total_utilization: Option<f64>,
    #[doc = "A value indicating the status of appliance resource."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub status: Option<String>,
}
impl ApplianceResourceDetails {
    pub fn new() -> Self {
        Self::default()
    }
}
...
pub struct AzureFabricSpecificDetails {
    ...
    pub extended_locations: Vec<A2aExtendedLocationDetails>,
    #[doc = "The location details."]
    #[serde(
        rename = "locationDetails",
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
        skip_serializing_if = "Vec::is_empty"
    )]
...
#[doc = "Critical past job details of the migration item."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct CriticalJobHistoryDetails {
    #[doc = "The job name."]
...
impl CriticalJobHistoryDetails {
    pub fn new() -> Self {
        Self::default()
    }
}
...
#[doc = "Details of the appliance resource."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct DataStoreUtilizationDetails {
    #[doc = "The total count of snapshots supported by the datastore."]
    #[serde(rename = "totalSnapshotsSupported", default, skip_serializing_if = "Option::is_none")]
    pub total_snapshots_supported: Option<i64>,
    #[doc = "The total snapshots created for server migration in the datastore."]
    #[serde(rename = "totalSnapshotsCreated", default, skip_serializing_if = "Option::is_none")]
    pub total_snapshots_created: Option<i64>,
...
impl DataStoreUtilizationDetails {
    pub fn new() -> Self {
        Self::default()
    }
}
...
pub struct FabricQueryParameter {
    ...
    #[doc = "A value indicating whether the Extended Location mappings are to be returned."]
    #[serde(rename = "extendedLocationMappings", default, skip_serializing_if = "Option::is_none")]
    pub extended_location_mappings: Option<String>,
    #[doc = "A value indicating whether the location details are to be returned."]
    #[serde(rename = "locationDetails", default, skip_serializing_if = "Option::is_none")]
...
#[doc = "Details of the gateway operation."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct GatewayOperationDetails {
    #[doc = "A value indicating the state of gateway operation."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub state: Option<String>,
    #[doc = "A value indicating the progress percentage of gateway operation."]
    #[serde(rename = "progressPercentage", default, skip_serializing_if = "Option::is_none")]
    pub progress_percentage: Option<i32>,
    #[doc = "A value indicating the time elapsed for the operation in milliseconds."]
    #[serde(rename = "timeElapsed", default, skip_serializing_if = "Option::is_none")]
    pub time_elapsed: Option<i64>,
    #[doc = "A value indicating the time remaining for the operation in milliseconds."]
    #[serde(rename = "timeRemaining", default, skip_serializing_if = "Option::is_none")]
    pub time_remaining: Option<i64>,
    #[doc = "A value indicating the upload speed in bytes per second."]
    #[serde(rename = "uploadSpeed", default, skip_serializing_if = "Option::is_none")]
    pub upload_speed: Option<i64>,
    #[doc = "A value indicating the ESXi host name."]
    #[serde(rename = "hostName", default, skip_serializing_if = "Option::is_none")]
    pub host_name: Option<String>,
    #[doc = "A value indicating the datastore collection."]
    #[serde(
        rename = "dataStores",
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
    ...
    #[doc = "A value indicating the VMware read throughput in bytes per second."]
    #[serde(rename = "vmwareReadThroughput", default, skip_serializing_if = "Option::is_none")]
    pub vmware_read_throughput: Option<i64>,
}
impl GatewayOperationDetails {
    pub fn new() -> Self {
        Self::default()
    }
}
...
pub struct HyperVReplicaAzureEnableProtectionInput {
    ...
    #[serde(
        rename = "disksToIncludeForManagedDisks",
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
        skip_serializing_if = "Vec::is_empty"
    )]
...
pub struct HyperVReplicaAzurePlannedFailoverProviderInput {
    ...
    #[serde(rename = "recoveryPointId", default, skip_serializing_if = "Option::is_none")]
    pub recovery_point_id: Option<String>,
    #[doc = "A value indicating the inplace OS Upgrade version."]
    #[serde(rename = "osUpgradeVersion", default, skip_serializing_if = "Option::is_none")]
...
pub struct HyperVReplicaAzureReplicationDetails {
    ...
    #[doc = "A value indicating all available inplace OS Upgrade configurations."]
    #[serde(
        rename = "allAvailableOSUpgradeConfigurations",
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
        skip_serializing_if = "Vec::is_empty"
    )]
...
impl HyperVReplicaAzureReplicationDetails {
    pub fn new(replication_provider_specific_settings: ReplicationProviderSpecificSettings) -> Self {
        Self {
            ...
            target_nic_tags: None,
            protected_managed_disks: Vec::new(),
            all_available_os_upgrade_configurations: Vec::new(),
        }
    }
}
#[doc = "Azure specific reprotect input."]
...
pub struct IpConfigDetails {
    ...
    #[serde(
        rename = "recoveryLBBackendAddressPoolIds",
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
        skip_serializing_if = "Vec::is_empty"
    )]
    ...
    #[serde(
        rename = "tfoLBBackendAddressPoolIds",
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
        skip_serializing_if = "Vec::is_empty"
    )]
...
pub struct InMageAzureV2ReplicationDetails {
    ...
    #[serde(
        rename = "switchProviderBlockingErrorDetails",
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
        skip_serializing_if = "Vec::is_empty"
    )]
    ...
    pub all_available_os_upgrade_configurations: Vec<OsUpgradeSupportedVersions>,
    #[doc = "The name of the OS on the VM."]
...
pub struct InMageRcmProtectedDiskDetails {
    ...
    #[serde(rename = "seedManagedDiskId", default, skip_serializing_if = "Option::is_none")]
    pub seed_managed_disk_id: Option<String>,
    #[doc = "The uri of the seed blob."]
    #[serde(rename = "seedBlobUri", default, skip_serializing_if = "Option::is_none")]
    pub seed_blob_uri: Option<String>,
...
pub struct InMageRcmReplicationDetails {
    ...
    #[serde(rename = "licenseType", default, skip_serializing_if = "Option::is_none")]
    pub license_type: Option<String>,
    #[doc = "The replication storage account ARM Id. This is applicable only for the blob based replication test hook."]
    #[serde(rename = "storageAccountId", default, skip_serializing_if = "Option::is_none")]
    pub storage_account_id: Option<String>,
    #[doc = "Target VM name."]
    #[serde(rename = "targetVmName", default, skip_serializing_if = "Option::is_none")]
    ...
    #[serde(
        rename = "lastAgentUpgradeErrorDetails",
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
        skip_serializing_if = "Vec::is_empty"
    )]
    ...
    #[serde(
        rename = "agentUpgradeBlockingErrorDetails",
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
        skip_serializing_if = "Vec::is_empty"
    )]
...
pub struct MigrationItemProperties {
    ...
    #[doc = "The critical past job details."]
    #[serde(
        rename = "criticalJobHistory",
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
        skip_serializing_if = "Vec::is_empty"
    )]
    pub critical_job_history: Vec<CriticalJobHistoryDetails>,
    ...
    impl Serialize for MigrationState {
            ...
            S: Serializer,
        {
            match self {
                ...
                Self::ResumeInProgress => serializer.serialize_unit_variant("MigrationState", 11u32, "ResumeInProgress"),
                Self::ResumeInitiated => serializer.serialize_unit_variant("MigrationState", 12u32, "ResumeInitiated"),
                Self::SuspendingProtection => serializer.serialize_unit_variant("MigrationState", 13u32, "SuspendingProtection"),
                Self::ProtectionSuspended => serializer.serialize_unit_variant("MigrationState", 14u32, "ProtectionSuspended"),
                Self::MigrationCompletedWithInformation => {
                    serializer.serialize_unit_variant("MigrationState", 15u32, "MigrationCompletedWithInformation")
                }
                Self::MigrationPartiallySucceeded => {
                    serializer.serialize_unit_variant("MigrationState", 16u32, "MigrationPartiallySucceeded")
                }
                Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
            }
        }
    ...
    impl Serialize for TestMigrateState {
            ...
            S: Serializer,
        {
            match self {
                ...
                Self::TestMigrationCompletedWithInformation => {
                    serializer.serialize_unit_variant("TestMigrateState", 5u32, "TestMigrationCompletedWithInformation")
                }
                Self::TestMigrationPartiallySucceeded => {
                    serializer.serialize_unit_variant("TestMigrateState", 6u32, "TestMigrationPartiallySucceeded")
                }
                Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
            }
        }
...
#[doc = "Supported OS upgrade versions."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct OsUpgradeSupportedVersions {
    #[doc = "The source OS version name."]
    #[serde(rename = "supportedSourceOsVersion", default, skip_serializing_if = "Option::is_none")]
    pub supported_source_os_version: Option<String>,
    #[doc = "The target OS version names."]
    #[serde(
        rename = "supportedTargetOsVersions",
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
        skip_serializing_if = "Vec::is_empty"
    )]
    pub supported_target_os_versions: Vec<String>,
}
impl OsUpgradeSupportedVersions {
    pub fn new() -> Self {
        Self::default()
    }
}
...
#[doc = "Pause replication input."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct PauseReplicationInput {
    #[doc = "Pause replication input properties."]
    pub properties: PauseReplicationInputProperties,
}
impl PauseReplicationInput {
    pub fn new(properties: PauseReplicationInputProperties) -> Self {
        Self { properties }
    }
}
#[doc = "Pause replication input properties."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct PauseReplicationInputProperties {
    #[doc = "The class type."]
    #[serde(rename = "instanceType")]
    pub instance_type: String,
}
impl PauseReplicationInputProperties {
    pub fn new(instance_type: String) -> Self {
        Self { instance_type }
    }
}
...
pub struct ProtectableItemProperties {
    ...
    #[serde(
        rename = "protectionReadinessErrors",
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
        skip_serializing_if = "Vec::is_empty"
    )]
    ...
    #[serde(
        rename = "supportedReplicationProviders",
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
        skip_serializing_if = "Vec::is_empty"
    )]
...
pub struct RecoveryPlanGroup {
    ...
    #[serde(
        rename = "replicationProtectedItems",
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
        skip_serializing_if = "Vec::is_empty"
    )]
...
pub struct RecoveryPlanPlannedFailoverInputProperties {
    ...
    #[serde(
        rename = "providerSpecificDetails",
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
        skip_serializing_if = "Vec::is_empty"
    )]
...
#[doc = "Resume replication input."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct ResumeReplicationInput {
    #[doc = "Resume replication input properties."]
    pub properties: ResumeReplicationInputProperties,
}
impl ResumeReplicationInput {
    pub fn new(properties: ResumeReplicationInputProperties) -> Self {
        Self { properties }
    }
}
#[doc = "Resume replication input properties."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct ResumeReplicationInputProperties {
    #[doc = "Resume replication provider specific input."]
    #[serde(rename = "providerSpecificDetails")]
    pub provider_specific_details: ResumeReplicationProviderSpecificInput,
}
impl ResumeReplicationInputProperties {
    pub fn new(provider_specific_details: ResumeReplicationProviderSpecificInput) -> Self {
        Self { provider_specific_details }
    }
}
#[doc = "Resume replication provider specific input."]
...
pub struct VMwareCbtEnableMigrationInput {
    ...
    pub perform_sql_bulk_registration: Option<String>,
    ...
    #[serde(rename = "targetProximityPlacementGroupId", default, skip_serializing_if = "Option::is_none")]
    pub target_proximity_placement_group_id: Option<String>,
    #[doc = "The confidential VM key vault Id for ADE installation."]
    #[serde(rename = "confidentialVmKeyVaultId", default, skip_serializing_if = "Option::is_none")]
    pub confidential_vm_key_vault_id: Option<String>,
    #[doc = "VMwareCbt security profile input."]
    #[serde(rename = "targetVmSecurityProfile", default, skip_serializing_if = "Option::is_none")]
    pub target_vm_security_profile: Option<VMwareCbtSecurityProfileProperties>,
    #[doc = "The target boot diagnostics storage account ARM Id."]
    #[serde(rename = "targetBootDiagnosticsStorageAccountId", default, skip_serializing_if = "Option::is_none")]
    pub target_boot_diagnostics_storage_account_id: Option<String>,
...
impl VMwareCbtEnableMigrationInput {
    pub fn new(
        ...
        Self {
            ...
            license_type: None,
            sql_server_license_type: None,
            perform_sql_bulk_registration: None,
            ...
            target_availability_zone: None,
            target_proximity_placement_group_id: None,
            confidential_vm_key_vault_id: None,
            target_vm_security_profile: None,
            target_boot_diagnostics_storage_account_id: None,
...
pub struct VMwareCbtMigrationDetails {
    ...
    #[serde(rename = "resyncProgressPercentage", default, skip_serializing_if = "Option::is_none")]
    pub resync_progress_percentage: Option<i32>,
    #[doc = "The resume progress percentage."]
    ...
    #[doc = "The delta sync progress percentage."]
    #[serde(rename = "deltaSyncProgressPercentage", default, skip_serializing_if = "Option::is_none")]
    pub delta_sync_progress_percentage: Option<i32>,
    #[doc = "A value indicating whether checksum resync cycle is in progress."]
    #[serde(rename = "isCheckSumResyncCycle", default, skip_serializing_if = "Option::is_none")]
    pub is_check_sum_resync_cycle: Option<String>,
    ...
    #[doc = "The resume retry count."]
    #[serde(rename = "resumeRetryCount", default, skip_serializing_if = "Option::is_none")]
    pub resume_retry_count: Option<i64>,
    #[doc = "The delta sync retry count."]
    #[serde(rename = "deltaSyncRetryCount", default, skip_serializing_if = "Option::is_none")]
    pub delta_sync_retry_count: Option<i64>,
    #[doc = "A value indicating whether resync is required."]
    #[serde(rename = "resyncRequired", default, skip_serializing_if = "Option::is_none")]
    pub resync_required: Option<String>,
    #[doc = "The resync state."]
    ...
    pub supported_os_versions: Vec<String>,
    #[doc = "Appliance details of the migration item."]
    #[serde(rename = "applianceMonitoringDetails", default, skip_serializing_if = "Option::is_none")]
    pub appliance_monitoring_details: Option<ApplianceMonitoringDetails>,
    #[doc = "Details of the gateway operation."]
    #[serde(rename = "gatewayOperationDetails", default, skip_serializing_if = "Option::is_none")]
    pub gateway_operation_details: Option<GatewayOperationDetails>,
    #[doc = "A value indicating the SRS operation name."]
...
impl VMwareCbtMigrationDetails {
    pub fn new(migration_provider_specific_settings: MigrationProviderSpecificSettings) -> Self {
        Self {
            ...
            delta_sync_progress_percentage: None,
            is_check_sum_resync_cycle: None,
            initial_seeding_retry_count: None,
            resync_retry_count: None,
            resume_retry_count: None,
            delta_sync_retry_count: None,
            resync_required: None,
            resync_state: None,
            perform_auto_resync: None,
            seed_disk_tags: None,
            target_disk_tags: None,
            supported_os_versions: Vec::new(),
            appliance_monitoring_details: None,
            gateway_operation_details: None,
            operation_name: None,
        }
    }
}
...
pub struct VMwareCbtProtectedDiskDetails {
    ...
    #[serde(rename = "targetManagedDiskId", default, skip_serializing_if = "Option::is_none")]
    pub target_managed_disk_id: Option<String>,
    #[doc = "The uri of the target blob."]
    #[serde(rename = "targetBlobUri", default, skip_serializing_if = "Option::is_none")]
    pub target_blob_uri: Option<String>,
...
pub struct VMwareCbtProtectionContainerMappingDetails {
    ...
    #[serde(rename = "targetLocation", default, skip_serializing_if = "Option::is_none")]
    pub target_location: Option<String>,
    #[doc = "The role size to NIC count map."]
    #[serde(rename = "roleSizeToNicCountMap", default, skip_serializing_if = "Option::is_none")]
    pub role_size_to_nic_count_map: Option<serde_json::Value>,
    #[doc = "The SKUs to be excluded."]
    #[serde(
        rename = "excludedSkus",
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
...
impl VMwareCbtProtectionContainerMappingDetails {
    pub fn new(protection_container_mapping_provider_specific_details: ProtectionContainerMappingProviderSpecificDetails) -> Self {
        Self {
            ...
            service_bus_connection_string_secret_name: None,
            target_location: None,
            role_size_to_nic_count_map: None,
...
pub struct VMwareCbtSecurityProfileProperties {
    ...
    pub is_target_vm_secure_boot_enabled: Option<String>,
    #[doc = "A value indicating whether trusted platform module to be enabled."]
    #[serde(rename = "isTargetVmTpmEnabled", default, skip_serializing_if = "Option::is_none")]
    pub is_target_vm_tpm_enabled: Option<String>,
    #[doc = "A value indicating whether integrity monitoring to be enabled."]
    #[serde(rename = "isTargetVmIntegrityMonitoringEnabled", default, skip_serializing_if = "Option::is_none")]
    pub is_target_vm_integrity_monitoring_enabled: Option<String>,
    #[doc = "A value indicating whether confidential compute encryption to be enabled."]
    #[serde(
        rename = "isTargetVmConfidentialEncryptionEnabled",
        default,
        skip_serializing_if = "Option::is_none"
    )]
    pub is_target_vm_confidential_encryption_enabled: Option<String>,
}
impl VMwareCbtSecurityProfileProperties {
    pub fn new() -> Self {
        Self::default()
    }
}
pub mod v_mware_cbt_security_profile_properties {
    use super::*;
    #[doc = "The target VM security type."]
    #[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
    #[serde(remote = "TargetVmSecurityType")]
    pub enum TargetVmSecurityType {
        None,
        TrustedLaunch,
    ...
    impl FromStr for TargetVmSecurityType {
        type Err = value::Error;
        fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
            Self::deserialize(s.into_deserializer())
        }
    }
    impl<'de> Deserialize<'de> for TargetVmSecurityType {
        fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
        where
            D: Deserializer<'de>,
        {
    ...
    impl Serialize for TargetVmSecurityType {
        fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
        where
            S: Serializer,
        {
            match self {
                Self::None => serializer.serialize_unit_variant("TargetVmSecurityType", 0u32, "None"),
                Self::TrustedLaunch => serializer.serialize_unit_variant("TargetVmSecurityType", 1u32, "TrustedLaunch"),
                Self::ConfidentialVm => serializer.serialize_unit_variant("TargetVmSecurityType", 2u32, "ConfidentialVM"),
                Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
            }
        }
    }
