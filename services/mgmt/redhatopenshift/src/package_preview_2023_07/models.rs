...
#[doc = "EffectiveOutboundIP represents an effective outbound IP resource of the cluster public load balancer."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct EffectiveOutboundIp {
    #[doc = "The fully qualified Azure resource id of an IP address resource."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub id: Option<String>,
}
impl EffectiveOutboundIp {
    pub fn new() -> Self {
        Self::default()
    }
}
...
#[doc = "LoadBalancerProfile represents the profile of the cluster public load balancer."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct LoadBalancerProfile {
    #[doc = "ManagedOutboundIPs represents the desired managed outbound IPs for the cluster public load balancer."]
    #[serde(rename = "managedOutboundIps", default, skip_serializing_if = "Option::is_none")]
    pub managed_outbound_ips: Option<ManagedOutboundIPs>,
    #[doc = "The list of effective outbound IP addresses of the public load balancer."]
    #[serde(
    ...
    pub effective_outbound_ips: Vec<EffectiveOutboundIp>,
    #[doc = "The desired outbound IP resources for the cluster load balancer."]
    #[serde(
        rename = "outboundIps",
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
    ...
    pub outbound_ips: Vec<OutboundIp>,
    #[doc = "The desired outbound IP Prefix resources for the cluster load balancer."]
    #[serde(
        rename = "outboundIpPrefixes",
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
        skip_serializing_if = "Vec::is_empty"
    )]
    pub outbound_ip_prefixes: Vec<OutboundIpPrefix>,
    #[doc = "The desired number of allocated SNAT ports per VM. Allowed values are in the range of 0 to 64000 (inclusive). The default value is 1024."]
...
#[doc = "MachinePoolList represents a list of MachinePools"]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct MachinePoolList {
    #[doc = "The list of Machine Pools."]
    #[serde(
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
        skip_serializing_if = "Vec::is_empty"
    )]
    pub value: Vec<MachinePool>,
...
#[doc = "MachinePoolProperties represents the properties of a MachinePool"]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct MachinePoolProperties {
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub resources: Option<String>,
}
impl MachinePoolProperties {
    pub fn new() -> Self {
        Self::default()
    }
}
...
pub struct ManagedOutboundIPs {
    #[doc = "Count represents the desired number of IPv4 outbound IPs created and managed by Azure for the cluster public load balancer.  Allowed values are in the range of 1 - 20.  The default value is 1."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
...
pub struct NetworkProfile {
    ...
    #[doc = "The outbound routing strategy used to provide your cluster egress to the internet."]
...
impl OpenShiftVersion {
    pub fn new() -> Self {
        Self::default()
    }
}
#[doc = "OpenShiftVersionList represents a List of available versions."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct OpenShiftVersionList {
    ...
    pub value: Vec<OpenShiftVersion>,
    #[doc = "Next Link to next operation."]
    #[serde(rename = "nextLink", default, skip_serializing_if = "Option::is_none")]
    pub next_link: Option<String>,
}
...
pub struct OpenShiftVersionProperties {
    #[doc = "Version represents the version to create the cluster at."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub version: Option<String>,
}
impl OpenShiftVersionProperties {
    pub fn new() -> Self {
        Self::default()
    }
}
...
#[doc = "OutboundIP represents a desired outbound IP resource for the cluster load balancer."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct OutboundIp {
    #[doc = "The fully qualified Azure resource id of the IP address resource."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub id: Option<String>,
}
impl OutboundIp {
...
#[doc = "OutboundIPPrefix represents a desired outbound IP Prefix resource for the cluster load balancer."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct OutboundIpPrefix {
    #[doc = "The fully qualified Azure resource id of an IP Prefix resource."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub id: Option<String>,
}
impl OutboundIpPrefix {
    pub fn new() -> Self {
        Self::default()
    }
}
...
#[doc = "SecretList represents a list of Secrets"]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
...
pub struct SecretProperties {
    #[doc = "The Secrets Resources."]
    #[serde(rename = "secretResources", default, skip_serializing_if = "Option::is_none")]
    pub secret_resources: Option<String>,
}
...
impl SyncIdentityProvider {
    pub fn new() -> Self {
        Self::default()
    }
}
#[doc = "SyncSetList represents a list of SyncSets"]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct SyncIdentityProviderList {
    #[doc = "The list of sync identity providers"]
    #[serde(
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
        skip_serializing_if = "Vec::is_empty"
    )]
    pub value: Vec<SyncIdentityProvider>,
    #[doc = "The link used to get the next page of operations."]
    #[serde(rename = "nextLink", default, skip_serializing_if = "Option::is_none")]
    pub next_link: Option<String>,
}
...
#[doc = "SyncSetProperties represents the properties of a SyncSet"]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct SyncIdentityProviderProperties {
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub resources: Option<String>,
}
impl SyncIdentityProviderProperties {
    pub fn new() -> Self {
        Self::default()
    }
}
#[doc = "SyncIdentityProvider represents a SyncIdentityProvider"]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct SyncIdentityProviderUpdate {
    #[doc = "SyncSetProperties represents the properties of a SyncSet"]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub properties: Option<SyncIdentityProviderProperties>,
    #[doc = "Metadata pertaining to creation and last modification of the resource."]
...
impl SyncIdentityProviderUpdate {
    pub fn new() -> Self {
        Self::default()
    }
}
...
#[doc = "SyncSetList represents a list of SyncSets"]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct SyncSetList {
    #[doc = "The list of syncsets."]
    #[serde(
        default,
        deserialize_with = "azure_core::util::deserialize_null_as_default",
        skip_serializing_if = "Vec::is_empty"
    )]
    pub value: Vec<SyncSet>,
    #[doc = "The link used to get the next page of operations."]
    #[serde(rename = "nextLink", default, skip_serializing_if = "Option::is_none")]
    pub next_link: Option<String>,
}
...
#[doc = "SyncSetProperties represents the properties of a SyncSet"]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct SyncSetProperties {
    #[doc = "Resources represents the SyncSets configuration."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub resources: Option<String>,
}
impl SyncSetProperties {
    pub fn new() -> Self {
        Self::default()
    }
}
