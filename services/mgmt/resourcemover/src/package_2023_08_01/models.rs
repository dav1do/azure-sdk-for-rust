...
pub struct MoveCollectionProperties {
    ...
    #[serde(rename = "sourceRegion", default, skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "moveRegion", default, skip_serializing_if = "Option::is_none")]
    pub move_region: Option<String>,
    ...
    #[serde(rename = "moveType", default, skip_serializing_if = "Option::is_none")]
...
impl Serialize for MoveType {
    ...
    {
        match self {
            Self::RegionToRegion => serializer.serialize_unit_variant("MoveType", 0u32, "RegionToRegion"),
            Self::RegionToZone => serializer.serialize_unit_variant("MoveType", 1u32, "RegionToZone"),
            Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
        }
    }
}
