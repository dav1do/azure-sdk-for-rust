...
#[doc = "Properties for creating and updating distributed availability group"]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct CreateOrUpdateProperties {
    ...
    pub replication_mode: Option<create_or_update_properties::ReplicationMode>,
}
impl CreateOrUpdateProperties {
    pub fn new() -> Self {
        Self::default()
    }
}
pub mod create_or_update_properties {
    use super::*;
    #[doc = "The replication mode of a distributed availability group. Parameter will be ignored during link creation."]
    #[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
...
#[doc = "Information for creating and updating distributed availability group"]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct DistributedAvailabilityGroupsCreateOrUpdateRequestBody {
    #[doc = "Properties for creating and updating distributed availability group"]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub properties: Option<CreateOrUpdateProperties>,
}
impl DistributedAvailabilityGroupsCreateOrUpdateRequestBody {
    pub fn new() -> Self {
        Self::default()
    }
}
