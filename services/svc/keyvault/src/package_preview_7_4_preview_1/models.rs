    ...
    impl Serialize for Kty {
            ...
            S: Serializer,
        {
            match self {
                ...
                Self::Okp => serializer.serialize_unit_variant("Kty", 6u32, "OKP"),
                Self::OkpHsm => serializer.serialize_unit_variant("Kty", 7u32, "OKP-HSM"),
                Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
            }
        }
    }
    ...
    impl Serialize for Crv {
            ...
            S: Serializer,
        {
            match self {
                ...
                Self::Ed25519 => serializer.serialize_unit_variant("Crv", 4u32, "Ed25519"),
                Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
            }
        }
    }
    ...
    impl Serialize for Alg {
            ...
            S: Serializer,
        {
            match self {
                ...
                Self::EdDsa => serializer.serialize_unit_variant("Alg", 11u32, "EdDSA"),
                Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
            }
        }
    }
