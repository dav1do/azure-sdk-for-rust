...
pub mod entity {
    ...
    impl Client {
        ...
        pub fn create_or_update(&self, entity: impl Into<models::AtlasEntityWithExtInfo>) -> create_or_update::RequestBuilder {
            create_or_update::RequestBuilder {
                client: self.0.clone(),
                entity: entity.into(),
                business_attribute_update_behavior: None,
            }
        }
    ...
    pub mod create_or_update {
        ...
        pub struct RequestBuilder {
            ...
            pub(crate) business_attribute_update_behavior: Option<String>,
        }
        impl RequestBuilder {
            #[doc = "Used to define the update behavior for business attributes when updating entities."]
            pub fn business_attribute_update_behavior(mut self, business_attribute_update_behavior: impl Into<String>) -> Self {
                self.business_attribute_update_behavior = Some(business_attribute_update_behavior.into());
                self
            }
            ...
            pub fn send(self) -> futures::future::BoxFuture<'static, azure_core::Result<Response>> {
                Box::pin({
                    ...
                    async move {
                        ...
                        if let Some(business_attribute_update_behavior) = &this.business_attribute_update_behavior {
                            req.url_mut()
                                .query_pairs_mut()
                                .append_pair("businessAttributeUpdateBehavior", business_attribute_update_behavior);
                        }
        ...
        impl std::future::IntoFuture for RequestBuilder {
            type Output = azure_core::Result<models::EntityMutationResponse>;
            type IntoFuture = futures::future::BoxFuture<'static, azure_core::Result<models::EntityMutationResponse>>;
    ...
    pub mod list_by_guids {
        ...
        impl std::future::IntoFuture for RequestBuilder {
            type Output = azure_core::Result<models::AtlasEntitiesWithExtInfo>;
            type IntoFuture = futures::future::BoxFuture<'static, azure_core::Result<models::AtlasEntitiesWithExtInfo>>;
            #[doc = "Returns a future that sends the request and returns the parsed response body."]
            #[doc = ""]
            #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
            #[doc = ""]
    ...
    pub mod get_by_guid {
        ...
        impl std::future::IntoFuture for RequestBuilder {
            type Output = azure_core::Result<models::AtlasEntityWithExtInfo>;
            type IntoFuture = futures::future::BoxFuture<'static, azure_core::Result<models::AtlasEntityWithExtInfo>>;
            #[doc = "Returns a future that sends the request and returns the parsed response body."]
            #[doc = ""]
            #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
            #[doc = ""]
    ...
    pub mod get_classification {
        ...
        impl std::future::IntoFuture for RequestBuilder {
            type Output = azure_core::Result<models::AtlasClassification>;
            type IntoFuture = futures::future::BoxFuture<'static, azure_core::Result<models::AtlasClassification>>;
            #[doc = "Returns a future that sends the request and returns the parsed response body."]
            #[doc = ""]
            #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
            #[doc = ""]
    ...
    pub mod get_classifications {
        ...
        impl std::future::IntoFuture for RequestBuilder {
            type Output = azure_core::Result<models::AtlasClassifications>;
            type IntoFuture = futures::future::BoxFuture<'static, azure_core::Result<models::AtlasClassifications>>;
            #[doc = "Returns a future that sends the request and returns the parsed response body."]
            #[doc = ""]
            #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
            #[doc = ""]
    ...
    pub mod get_by_unique_attributes {
        ...
        impl RequestBuilder {
            ...
            #[doc = "The qualified name of the entity. (This is only an example. qualifiedName can be changed to other unique attributes)"]
    ...
    pub mod get_entities_by_unique_attributes {
        ...
        impl RequestBuilder {
            ...
            #[doc = "Qualified name of an entity. E.g. to find 2 entities you can set attrs_1:qualifiedName=db1@cl1&attrs_2:qualifiedName=db2@cl1. (This is only an example. qualifiedName can be changed to other unique attributes)"]
    ...
    pub mod get_header {
        ...
        impl std::future::IntoFuture for RequestBuilder {
            type Output = azure_core::Result<models::AtlasEntityHeader>;
            type IntoFuture = futures::future::BoxFuture<'static, azure_core::Result<models::AtlasEntityHeader>>;
            #[doc = "Returns a future that sends the request and returns the parsed response body."]
            #[doc = ""]
            #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
            #[doc = ""]
    ...
    pub mod import_business_metadata {
        ...
        impl std::future::IntoFuture for RequestBuilder {
            type Output = azure_core::Result<models::BulkImportResponse>;
            type IntoFuture = futures::future::BoxFuture<'static, azure_core::Result<models::BulkImportResponse>>;
            #[doc = "Returns a future that sends the request and returns the parsed response body."]
            #[doc = ""]
            #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
            #[doc = ""]
...
pub mod glossary {
    ...
    pub struct Client(pub(crate) super::Client);
    impl Client {
        #[doc = "Get all glossaries registered with Atlas. Recommend using limit/offset to get pagination result. Recommended using 'ignoreTermsAndCategories=true' and fetch terms/categories separately using 'GET /catalog/api/atlas/v2/glossary/{glossaryGuid}/terms' and 'GET '/catalog/api/atlas/v2/glossary/{glossaryGuid}/categories'."]
        ...
        #[doc = "Update the glossary category partially. So far we only supports partial updating shortDescription and longDescription for category."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `category_guid`: The globally unique identifier of the category."]
        ...
        #[doc = "Get a specific glossary term by its GUID.  Recommend using 'excludeRelationshipTypes=AtlasGlossarySemanticAssignment' to get term and using 'GET /catalog/api/atlas/v2/glossary/terms/{termGuid}/assignedEntities' to get term assignment separately."]
        #[doc = ""]
        #[doc = "Arguments:"]
        ...
        #[doc = "Update the glossary term partially. So far we only supports partial updating shortDescription, longDescription, abbreviation, usage and status for term."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `term_guid`: The globally unique identifier for glossary term."]
        ...
        #[doc = "Get all related objects assigned with the specified term. Recommend using limit/offset to get pagination result."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `term_guid`: The globally unique identifier for glossary term."]
        ...
        #[doc = "Assign the given term to the provided list of related objects. Recommend using small batches with multiple API calls."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `term_guid`: The globally unique identifier for glossary term."]
        ...
        #[doc = "Delete the term assignment for the given list of related objects. This API is not recommended since duplicated with 'DELETE /catalog/api/atlas/v2/glossary/terms/{termGuid}/assignedEntities'. Please use later one instead."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `term_guid`: The globally unique identifier for glossary term."]
        ...
        #[doc = "Delete a glossary. Will delete underlying terms/categories together. Recommend separate delete terms and categories."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `glossary_guid`: The globally unique identifier for glossary."]
        ...
        #[doc = "Get the categories belonging to a specific glossary. Recommend using limit/offset to get pagination result."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `glossary_guid`: The globally unique identifier for glossary."]
        ...
        #[doc = "Get the category headers belonging to a specific glossary. Recommend using limit/offset to get pagination result."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `glossary_guid`: The globally unique identifier for glossary."]
        ...
        #[doc = "Get a specific glossary with detailed information. This API is not recommend. Recommended fetch terms/categories details separately using 'GET /catalog/api/atlas/v2/glossary/{glossaryGuid}/terms' and 'GET '/catalog/api/atlas/v2/glossary/{glossaryGuid}/categories'."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `glossary_guid`: The globally unique identifier for glossary."]
        ...
        #[doc = "Update the glossary partially. Some properties such as qualifiedName are not allowed to be updated. So far we only supports partial updating shortDescription, longDescription, language and usage for glossary. Recommend using 'ignoreTermsAndCategories=true' to reduce response body size."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `glossary_guid`: The globally unique identifier for glossary."]
        ...
        #[doc = "Get terms belonging to a specific glossary. Recommend using limit/offset to get pagination result."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `glossary_guid`: The globally unique identifier for glossary."]
        ...
        #[doc = "Get term headers belonging to a specific glossary. Recommend using limit/offset to get pagination result."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `glossary_guid`: The globally unique identifier for glossary."]
        ...
        #[doc = "Import Glossary Terms from local csv file. Note the csv file should be uploaded in formData with key='file'."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `glossary_guid`: The globally unique identifier for glossary."]
        ...
        pub fn import_glossary_terms_via_csv(
            ...
            import_glossary_terms_via_csv::RequestBuilder {
                ...
                file: file.into(),
                include_term_hierarchy: None,
                include_multi_templates: None,
            }
        }
        #[doc = "Import Glossary Terms from local csv file by glossaryName. Note this API has been deprecated. Please use 'POST /catalog/api/glossary/{glossaryGuid}/terms/import' instead."]
        #[doc = ""]
        #[doc = "Arguments:"]
        ...
        pub fn export_glossary_terms_as_csv(
            ...
            export_glossary_terms_as_csv::RequestBuilder {
                ...
                include_term_hierarchy: None,
                include_multi_templates: None,
                include_rich_text_flag: None,
            }
        }
        #[doc = "Get terms by glossary name. Note this API has been deprecated. Please use 'GET /catalog/api/glossary/{glossaryGuid}/terms' instead."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `glossary_name`: The name of the glossary."]
        ...
        #[doc = "Get the status of bulk delete operation"]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `operation_guid`: The globally unique identifier for async operation job."]
        pub fn get_bulk_delete_operation_status(
            &self,
            operation_guid: impl Into<String>,
        ) -> get_bulk_delete_operation_status::RequestBuilder {
            get_bulk_delete_operation_status::RequestBuilder {
                client: self.0.clone(),
                operation_guid: operation_guid.into(),
            }
        }
        #[doc = "Delete Glossary Terms"]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `term_guids`: An array of term guids to be deleted."]
        pub fn bulk_delete_terms_by_guids(&self, term_guids: Vec<models::TermGuid>) -> bulk_delete_terms_by_guids::RequestBuilder {
            bulk_delete_terms_by_guids::RequestBuilder {
                client: self.0.clone(),
                term_guids,
                force_delete_entity_assignment: None,
                force_delete_child: None,
            }
        }
        #[doc = "Get terms by guids."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `guid`: An array of GUIDs of terms to list."]
        pub fn list_terms_by_guids(&self, guid: Vec<String>) -> list_terms_by_guids::RequestBuilder {
            list_terms_by_guids::RequestBuilder {
                client: self.0.clone(),
                guid,
                exclude_relationship_types: Vec::new(),
            }
        }
        #[doc = "Update terms in bulk."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `terms`: An array of terms to update."]
        pub fn bulk_update_terms(&self, terms: Vec<models::AtlasGlossaryTerm>) -> bulk_update_terms::RequestBuilder {
            bulk_update_terms::RequestBuilder {
                client: self.0.clone(),
                terms,
            }
        }
    ...
    pub mod list_glossaries {
        ...
        impl std::future::IntoFuture for RequestBuilder {
            type Output = azure_core::Result<Vec<models::AtlasGlossary>>;
            type IntoFuture = futures::future::BoxFuture<'static, azure_core::Result<Vec<models::AtlasGlossary>>>;
            #[doc = "Returns a future that sends the request and returns the parsed response body."]
            #[doc = ""]
            #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
            #[doc = ""]
    ...
    pub mod create_glossary {
        ...
        impl std::future::IntoFuture for RequestBuilder {
            type Output = azure_core::Result<models::AtlasGlossary>;
            type IntoFuture = futures::future::BoxFuture<'static, azure_core::Result<models::AtlasGlossary>>;
            #[doc = "Returns a future that sends the request and returns the parsed response body."]
            #[doc = ""]
            #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
            #[doc = ""]
    ...
    pub mod create_glossary_categories {
        ...
        impl std::future::IntoFuture for RequestBuilder {
            type Output = azure_core::Result<Vec<models::AtlasGlossaryCategory>>;
            type IntoFuture = futures::future::BoxFuture<'static, azure_core::Result<Vec<models::AtlasGlossaryCategory>>>;
            #[doc = "Returns a future that sends the request and returns the parsed response body."]
            #[doc = ""]
            #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
            #[doc = ""]
    ...
    pub mod create_glossary_category {
        ...
        impl std::future::IntoFuture for RequestBuilder {
            type Output = azure_core::Result<models::AtlasGlossaryCategory>;
            type IntoFuture = futures::future::BoxFuture<'static, azure_core::Result<models::AtlasGlossaryCategory>>;
            #[doc = "Returns a future that sends the request and returns the parsed response body."]
            #[doc = ""]
            #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
            #[doc = ""]
    ...
    pub mod list_category_terms {
        ...
        impl std::future::IntoFuture for RequestBuilder {
            type Output = azure_core::Result<Vec<models::AtlasRelatedTermHeader>>;
            type IntoFuture = futures::future::BoxFuture<'static, azure_core::Result<Vec<models::AtlasRelatedTermHeader>>>;
            #[doc = "Returns a future that sends the request and returns the parsed response body."]
            #[doc = ""]
            #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
            #[doc = ""]
    ...
    pub mod create_glossary_term {
        ...
        impl std::future::IntoFuture for RequestBuilder {
            type Output = azure_core::Result<models::AtlasGlossaryTerm>;
            type IntoFuture = futures::future::BoxFuture<'static, azure_core::Result<models::AtlasGlossaryTerm>>;
            #[doc = "Returns a future that sends the request and returns the parsed response body."]
            #[doc = ""]
            #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
            #[doc = ""]
    ...
    pub mod create_glossary_terms {
        ...
        impl std::future::IntoFuture for RequestBuilder {
            type Output = azure_core::Result<Vec<models::AtlasGlossaryTerm>>;
            type IntoFuture = futures::future::BoxFuture<'static, azure_core::Result<Vec<models::AtlasGlossaryTerm>>>;
            #[doc = "Returns a future that sends the request and returns the parsed response body."]
            #[doc = ""]
            #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
            #[doc = ""]
    ...
    pub mod get_entities_assigned_with_term {
        ...
        impl std::future::IntoFuture for RequestBuilder {
            type Output = azure_core::Result<Vec<models::AtlasRelatedObjectId>>;
            type IntoFuture = futures::future::BoxFuture<'static, azure_core::Result<Vec<models::AtlasRelatedObjectId>>>;
            #[doc = "Returns a future that sends the request and returns the parsed response body."]
            #[doc = ""]
            #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
            #[doc = ""]
    ...
    pub mod list_glossary_categories_headers {
        ...
        impl std::future::IntoFuture for RequestBuilder {
            type Output = azure_core::Result<Vec<models::AtlasRelatedCategoryHeader>>;
            type IntoFuture = futures::future::BoxFuture<'static, azure_core::Result<Vec<models::AtlasRelatedCategoryHeader>>>;
            #[doc = "Returns a future that sends the request and returns the parsed response body."]
            #[doc = ""]
            #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
            #[doc = ""]
    ...
    pub mod get_detailed_glossary {
        ...
        impl std::future::IntoFuture for RequestBuilder {
            type Output = azure_core::Result<models::AtlasGlossaryExtInfo>;
            type IntoFuture = futures::future::BoxFuture<'static, azure_core::Result<models::AtlasGlossaryExtInfo>>;
            #[doc = "Returns a future that sends the request and returns the parsed response body."]
            #[doc = ""]
            #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
            #[doc = ""]
    ...
    pub mod import_glossary_terms_via_csv {
        ...
        impl<'a> Headers<'a> {
            #[doc = "Response header for long running operation"]
        ...
        pub struct RequestBuilder {
            ...
            pub(crate) include_term_hierarchy: Option<bool>,
            pub(crate) include_multi_templates: Option<bool>,
        }
        impl RequestBuilder {
            #[doc = "Whether include term hierarchy"]
            pub fn include_term_hierarchy(mut self, include_term_hierarchy: bool) -> Self {
            ...
            #[doc = "Whether include multi term templates for term import/export"]
            pub fn include_multi_templates(mut self, include_multi_templates: bool) -> Self {
                self.include_multi_templates = Some(include_multi_templates);
                self
            }
            ...
            pub fn send(self) -> futures::future::BoxFuture<'static, azure_core::Result<Response>> {
                Box::pin({
                    ...
                    async move {
                        ...
                        if let Some(include_multi_templates) = &this.include_multi_templates {
                            req.url_mut()
                                .query_pairs_mut()
                                .append_pair("includeMultiTemplates", &include_multi_templates.to_string());
                        }
                        unimplemented!("form data not yet supported");
                        let req_body = azure_core::EMPTY_BODY;
                        req.insert_header(azure_core::headers::CONTENT_LENGTH, "0");
    ...
    pub mod get_import_csv_operation_status {
        ...
        impl std::future::IntoFuture for RequestBuilder {
            type Output = azure_core::Result<models::ImportCsvOperation>;
            type IntoFuture = futures::future::BoxFuture<'static, azure_core::Result<models::ImportCsvOperation>>;
            #[doc = "Returns a future that sends the request and returns the parsed response body."]
            #[doc = ""]
            #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
            #[doc = ""]
    ...
    pub mod export_glossary_terms_as_csv {
        ...
        pub struct RequestBuilder {
            ...
            pub(crate) include_term_hierarchy: Option<bool>,
            pub(crate) include_multi_templates: Option<bool>,
            pub(crate) include_rich_text_flag: Option<bool>,
        }
        impl RequestBuilder {
            #[doc = "Whether include term hierarchy"]
            pub fn include_term_hierarchy(mut self, include_term_hierarchy: bool) -> Self {
            ...
            #[doc = "Whether include rich text for term export"]
            pub fn include_rich_text_flag(mut self, include_rich_text_flag: bool) -> Self {
                self.include_rich_text_flag = Some(include_rich_text_flag);
                self
            }
            #[doc = "Returns a future that sends the request and returns a [`Response`] object that provides low-level access to full response details."]
            #[doc = ""]
            ...
            pub fn send(self) -> futures::future::BoxFuture<'static, azure_core::Result<Response>> {
                Box::pin({
                    ...
                    async move {
                        ...
                        if let Some(include_rich_text_flag) = &this.include_rich_text_flag {
                            req.url_mut()
                                .query_pairs_mut()
                                .append_pair("includeRichTextFlag", &include_rich_text_flag.to_string());
                        }
                        req.insert_header("content-type", "application/json");
    ...
    pub mod list_terms_by_glossary_name {
        ...
        pub struct RequestBuilder {
            ...
            pub(crate) offset: Option<i32>,
            pub(crate) include_term_hierarchy: Option<bool>,
            pub(crate) ext_info: Option<bool>,
        }
        impl RequestBuilder {
            #[doc = "The page size - by default there is no paging."]
            pub fn limit(mut self, limit: i32) -> Self {
            ...
            #[doc = "Whether include extended information like contact display name and attribute values"]
            pub fn ext_info(mut self, ext_info: bool) -> Self {
            ...
            pub fn send(self) -> futures::future::BoxFuture<'static, azure_core::Result<Response>> {
                Box::pin({
                    ...
                    async move {
                        ...
                        if let Some(ext_info) = &this.ext_info {
                            req.url_mut().query_pairs_mut().append_pair("extInfo", &ext_info.to_string());
                        }
                        let req_body = azure_core::EMPTY_BODY;
                        req.set_body(req_body);
                        Ok(Response(this.client.send(&mut req).await?))
    ...
    pub mod get_bulk_delete_operation_status {
        use super::models;
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::BulkDeleteOperation> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::BulkDeleteOperation = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        impl std::future::IntoFuture for RequestBuilder {
            type Output = azure_core::Result<models::BulkDeleteOperation>;
            type IntoFuture = futures::future::BoxFuture<'static, azure_core::Result<models::BulkDeleteOperation>>;
            #[doc = "Returns a future that sends the request and returns the parsed response body."]
            #[doc = ""]
            #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
            #[doc = ""]
    ...
    pub mod bulk_delete_terms_by_guids {
        use super::models;
        pub struct Response(azure_core::Response);
        impl Response {
            pub fn into_raw_response(self) -> azure_core::Response {
        ...
        pub struct RequestBuilder {
            pub(crate) client: super::super::Client,
            pub(crate) term_guids: Vec<models::TermGuid>,
            pub(crate) force_delete_entity_assignment: Option<bool>,
            pub(crate) force_delete_child: Option<bool>,
        }
        impl RequestBuilder {
            #[doc = "Whether delete entity assignment"]
            pub fn force_delete_entity_assignment(mut self, force_delete_entity_assignment: bool) -> Self {
                self.force_delete_entity_assignment = Some(force_delete_entity_assignment);
                self
            }
            #[doc = "Whether delete child terms together with the parent term"]
            pub fn force_delete_child(mut self, force_delete_child: bool) -> Self {
                self.force_delete_child = Some(force_delete_child);
                self
            }
            #[doc = "only the first response will be fetched as long running operations are not supported yet"]
            #[doc = "Returns a future that sends the request and returns a [`Response`] object that provides low-level access to full response details."]
            ...
            pub fn send(self) -> futures::future::BoxFuture<'static, azure_core::Result<Response>> {
                Box::pin({
                    let this = self.clone();
                    async move {
                        let url = azure_core::Url::parse(&format!("{}/glossary/terms:delete", this.client.endpoint(),))?;
                        let mut req = azure_core::Request::new(url, azure_core::Method::Post);
                        let credential = this.client.token_credential();
                        let token_response = credential.get_token(&this.client.scopes().join(" ")).await?;
                        req.insert_header(
                        ...
                        req.url_mut()
                            .query_pairs_mut()
                            .append_pair(azure_core::query_param::API_VERSION, "2023-02-01-preview");
                        if let Some(force_delete_entity_assignment) = &this.force_delete_entity_assignment {
                            req.url_mut()
                                .query_pairs_mut()
                                .append_pair("forceDeleteEntityAssignment", &force_delete_entity_assignment.to_string());
                        }
                        if let Some(force_delete_child) = &this.force_delete_child {
                            req.url_mut()
                                .query_pairs_mut()
                                .append_pair("forceDeleteChild", &force_delete_child.to_string());
                        }
                        req.insert_header("content-type", "application/json");
                        let req_body = azure_core::to_json(&this.term_guids)?;
                        req.set_body(req_body);
        ...
        impl RequestBuilder {
            ...
            pub fn send(self) -> futures::future::BoxFuture<'static, azure_core::Result<Response>> {
                Box::pin({
                    let this = self.clone();
                    async move {
                        let url = azure_core::Url::parse(&format!("{}/glossary/terms", this.client.endpoint(),))?;
                        let mut req = azure_core::Request::new(url, azure_core::Method::Get);
                        let credential = this.client.token_credential();
                        let token_response = credential.get_token(&this.client.scopes().join(" ")).await?;
                        req.insert_header(
    ...
    pub mod bulk_update_terms {
        ...
        pub struct RequestBuilder {
            pub(crate) client: super::super::Client,
            pub(crate) terms: Vec<models::AtlasGlossaryTerm>,
        }
        impl RequestBuilder {
            #[doc = "Returns a future that sends the request and returns a [`Response`] object that provides low-level access to full response details."]
            #[doc = ""]
            ...
            pub fn send(self) -> futures::future::BoxFuture<'static, azure_core::Result<Response>> {
                Box::pin({
                    ...
                    async move {
                        ...
                        req.insert_header("content-type", "application/json");
                        let req_body = azure_core::to_json(&this.terms)?;
                        req.set_body(req_body);
                        Ok(Response(this.client.send(&mut req).await?))
                    }
                })
...
pub mod discovery {
    ...
    pub mod query {
        ...
        impl std::future::IntoFuture for RequestBuilder {
            type Output = azure_core::Result<models::SearchResult>;
            type IntoFuture = futures::future::BoxFuture<'static, azure_core::Result<models::SearchResult>>;
            #[doc = "Returns a future that sends the request and returns the parsed response body."]
            #[doc = ""]
            #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
            #[doc = ""]
    ...
    pub mod suggest {
        ...
        impl std::future::IntoFuture for RequestBuilder {
            type Output = azure_core::Result<models::SuggestResult>;
            type IntoFuture = futures::future::BoxFuture<'static, azure_core::Result<models::SuggestResult>>;
            #[doc = "Returns a future that sends the request and returns the parsed response body."]
            #[doc = ""]
            #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
            #[doc = ""]
    ...
    pub mod browse {
        ...
        impl std::future::IntoFuture for RequestBuilder {
            type Output = azure_core::Result<models::BrowseResult>;
            type IntoFuture = futures::future::BoxFuture<'static, azure_core::Result<models::BrowseResult>>;
            #[doc = "Returns a future that sends the request and returns the parsed response body."]
            #[doc = ""]
            #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
            #[doc = ""]
    ...
    pub mod auto_complete {
        ...
        impl std::future::IntoFuture for RequestBuilder {
            ...
            type IntoFuture = futures::future::BoxFuture<'static, azure_core::Result<models::AutoCompleteResult>>;
            #[doc = "Returns a future that sends the request and returns the parsed response body."]
            #[doc = ""]
            #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
            #[doc = ""]
...
pub mod lineage {
    ...
    pub mod get_lineage_graph {
        ...
        impl std::future::IntoFuture for RequestBuilder {
            type Output = azure_core::Result<models::AtlasLineageInfo>;
            type IntoFuture = futures::future::BoxFuture<'static, azure_core::Result<models::AtlasLineageInfo>>;
            #[doc = "Returns a future that sends the request and returns the parsed response body."]
            #[doc = ""]
            #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
            #[doc = ""]
...
pub mod relationship {
    ...
    pub mod create {
        ...
        impl std::future::IntoFuture for RequestBuilder {
            type Output = azure_core::Result<models::AtlasRelationship>;
            type IntoFuture = futures::future::BoxFuture<'static, azure_core::Result<models::AtlasRelationship>>;
            #[doc = "Returns a future that sends the request and returns the parsed response body."]
            #[doc = ""]
            #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
            #[doc = ""]
    ...
    pub mod get {
        ...
        impl std::future::IntoFuture for RequestBuilder {
            type Output = azure_core::Result<models::AtlasRelationshipWithExtInfo>;
            type IntoFuture = futures::future::BoxFuture<'static, azure_core::Result<models::AtlasRelationshipWithExtInfo>>;
            #[doc = "Returns a future that sends the request and returns the parsed response body."]
            #[doc = ""]
            #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
            #[doc = ""]
...
pub mod types {
    ...
    pub mod get_business_metadata_def_by_guid {
        ...
        impl std::future::IntoFuture for RequestBuilder {
            type Output = azure_core::Result<models::AtlasBusinessMetadataDef>;
            type IntoFuture = futures::future::BoxFuture<'static, azure_core::Result<models::AtlasBusinessMetadataDef>>;
            #[doc = "Returns a future that sends the request and returns the parsed response body."]
            #[doc = ""]
            #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
            #[doc = ""]
    ...
    pub mod get_classification_def_by_guid {
        ...
        impl std::future::IntoFuture for RequestBuilder {
            type Output = azure_core::Result<models::AtlasClassificationDef>;
            type IntoFuture = futures::future::BoxFuture<'static, azure_core::Result<models::AtlasClassificationDef>>;
            #[doc = "Returns a future that sends the request and returns the parsed response body."]
            #[doc = ""]
            #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
            #[doc = ""]
    ...
    pub mod get_entity_definition_by_guid {
        ...
        impl std::future::IntoFuture for RequestBuilder {
            type Output = azure_core::Result<models::AtlasEntityDef>;
            type IntoFuture = futures::future::BoxFuture<'static, azure_core::Result<models::AtlasEntityDef>>;
            #[doc = "Returns a future that sends the request and returns the parsed response body."]
            #[doc = ""]
            #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
            #[doc = ""]
    ...
    pub mod get_enum_def_by_guid {
        ...
        impl std::future::IntoFuture for RequestBuilder {
            type Output = azure_core::Result<models::AtlasEnumDef>;
            type IntoFuture = futures::future::BoxFuture<'static, azure_core::Result<models::AtlasEnumDef>>;
            #[doc = "Returns a future that sends the request and returns the parsed response body."]
            #[doc = ""]
            #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
            #[doc = ""]
    ...
    pub mod get_relationship_def_by_guid {
        ...
        impl std::future::IntoFuture for RequestBuilder {
            type Output = azure_core::Result<models::AtlasRelationshipDef>;
            type IntoFuture = futures::future::BoxFuture<'static, azure_core::Result<models::AtlasRelationshipDef>>;
            #[doc = "Returns a future that sends the request and returns the parsed response body."]
            #[doc = ""]
            #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
            #[doc = ""]
    ...
    pub mod get_struct_def_by_guid {
        ...
        impl std::future::IntoFuture for RequestBuilder {
            type Output = azure_core::Result<models::AtlasStructDef>;
            type IntoFuture = futures::future::BoxFuture<'static, azure_core::Result<models::AtlasStructDef>>;
            #[doc = "Returns a future that sends the request and returns the parsed response body."]
            #[doc = ""]
            #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
            #[doc = ""]
    ...
    pub mod get_type_definition_by_guid {
        ...
        impl std::future::IntoFuture for RequestBuilder {
            type Output = azure_core::Result<models::AtlasTypeDef>;
            type IntoFuture = futures::future::BoxFuture<'static, azure_core::Result<models::AtlasTypeDef>>;
            #[doc = "Returns a future that sends the request and returns the parsed response body."]
            #[doc = ""]
            #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
            #[doc = ""]
    ...
    pub mod get_all_type_definitions {
        ...
        impl std::future::IntoFuture for RequestBuilder {
            type Output = azure_core::Result<models::AtlasTypesDef>;
            type IntoFuture = futures::future::BoxFuture<'static, azure_core::Result<models::AtlasTypesDef>>;
            #[doc = "Returns a future that sends the request and returns the parsed response body."]
            #[doc = ""]
            #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
            #[doc = ""]
    ...
    pub mod list_type_definition_headers {
        ...
        impl std::future::IntoFuture for RequestBuilder {
            type Output = azure_core::Result<Vec<models::AtlasTypeDefHeader>>;
            type IntoFuture = futures::future::BoxFuture<'static, azure_core::Result<Vec<models::AtlasTypeDefHeader>>>;
            #[doc = "Returns a future that sends the request and returns the parsed response body."]
            #[doc = ""]
            #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
            #[doc = ""]
    ...
    pub mod get_term_template_def_by_guid {
        ...
        impl std::future::IntoFuture for RequestBuilder {
            type Output = azure_core::Result<models::TermTemplateDef>;
            type IntoFuture = futures::future::BoxFuture<'static, azure_core::Result<models::TermTemplateDef>>;
            #[doc = "Returns a future that sends the request and returns the parsed response body."]
            #[doc = ""]
            #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
            #[doc = ""]
