...
pub struct AsyncOperationError {
    #[doc = "Code from async job if fail"]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub code: Option<String>,
    #[doc = "Message from async job if fail"]
    #[serde(default, skip_serializing_if = "Option::is_none")]
...
#[doc = "The status of bulk delete operation"]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct BulkDeleteOperation {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub properties: Option<BulkDeleteOperationProperties>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub error: Option<AsyncOperationError>,
}
impl BulkDeleteOperation {
    pub fn new(id: String, status: BulkDeleteOperationStatus) -> Self {
        Self {
            id,
            status,
            create_time: None,
...
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct BulkDeleteOperationProperties {
    #[doc = "Term numbers that already deleted successfully"]
    #[serde(rename = "deletedTerms", default, skip_serializing_if = "Option::is_none")]
    pub deleted_terms: Option<String>,
    #[doc = "Total term numbers that detected in a bulk delete job"]
    #[serde(rename = "totalTermsDetected", default, skip_serializing_if = "Option::is_none")]
    pub total_terms_detected: Option<String>,
}
impl BulkDeleteOperationProperties {
    pub fn new() -> Self {
        Self::default()
    }
}
#[doc = "Enum of the status of bulk delete operation."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
#[serde(remote = "BulkDeleteOperationStatus")]
pub enum BulkDeleteOperationStatus {
    NotStarted,
    Succeeded,
    Failed,
    Running,
...
impl FromStr for BulkDeleteOperationStatus {
    type Err = value::Error;
    fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
        Self::deserialize(s.into_deserializer())
    }
}
impl<'de> Deserialize<'de> for BulkDeleteOperationStatus {
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: Deserializer<'de>,
    {
...
impl Serialize for BulkDeleteOperationStatus {
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: Serializer,
    {
        match self {
            Self::NotStarted => serializer.serialize_unit_variant("BulkDeleteOperationStatus", 0u32, "NotStarted"),
            Self::Succeeded => serializer.serialize_unit_variant("BulkDeleteOperationStatus", 1u32, "Succeeded"),
            Self::Failed => serializer.serialize_unit_variant("BulkDeleteOperationStatus", 2u32, "Failed"),
            Self::Running => serializer.serialize_unit_variant("BulkDeleteOperationStatus", 3u32, "Running"),
            Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
        }
    }
}
...
pub struct DateFormat {
    ...
    pub date_instance: Option<DateFormat>,
    #[doc = "The date format."]
    #[serde(rename = "dateTimeInstance", default, skip_serializing_if = "Option::is_none")]
    pub date_time_instance: Option<DateFormat>,
    #[doc = "The date format."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub instance: Option<DateFormat>,
    ...
    pub time_instance: Option<DateFormat>,
...
impl ImportCsvOperation {
    pub fn new(id: String, status: ImportCsvOperationStatus) -> Self {
        Self {
            id,
            status,
            create_time: None,
...
pub struct NumberFormat {
    ...
    pub currency_instance: Option<NumberFormat>,
    ...
    #[doc = "The number format."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub instance: Option<NumberFormat>,
    #[doc = "The number format."]
    #[serde(rename = "integerInstance", default, skip_serializing_if = "Option::is_none")]
    pub integer_instance: Option<NumberFormat>,
    ...
    pub number_instance: Option<NumberFormat>,
    ...
    pub percent_instance: Option<NumberFormat>,
